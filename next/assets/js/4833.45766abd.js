...
void main() {
  ${r} = ${a};
}`}},79399(e,t,i){i.d(t,{_:()=>eS});var r=i(72560),n=i(65261),s=i(31770);let a=[[/^(#version[ \t]+(100|300[ \t]+es))?[ \t]*\n/,"#version 300 es\n"],[/\btexture(2D|2DProj|Cube)Lod(EXT)?\(/g,"textureLod("],[/\btexture(2D|2DProj|Cube)(EXT)?\(/g,"texture("]],o=[...a,[f("attribute"),"in $1"],[f("varying"),"out $1"]],u=[...a,[f("varying"),"in $1"]];function l(e,t){for(let[i,r]of t)e=e.replace(i,r);return e}function f(e){return RegExp(`\\b${e}[ \\t]+(\\w+[ \\t]+\\w+(\\[\\w+\\])?;)`,"g")}function h(e,t){if(!e){let e=Error(t||"shadertools: assertion failed.");throw Error.captureStackTrace?.(e,h),e}}let c=/^(?:uniform\s+)?(?:(?:lowp|mediump|highp)\s+)?[A-Za-z0-9_]+(?:<[^>]+>)?\s+([A-Za-z0-9_]+)(?:\s*\[[^\]]+\])?\s*;/,d=/((?:layout\s*\([^)]*\)\s*)*)uniform\s+([A-Za-z_][A-Za-z0-9_]*)\s*\{([\s\S]*?)\}\s*([A-Za-z_][A-Za-z0-9_]*)?\s*;/g;function p(e){return`${e.name}Uniforms`}function g(e){let t=[];for(let i of e.replace(/\/\*[\s\S]*?\*\//g,"").replace(/\/\/.*$/gm,"").matchAll(d)){let e=i[1]?.trim()||null;t.push({blockName:i[2],body:i[3],instanceName:i[4]||null,layoutQualifier:e,hasLayoutQualifier:!!e,isStd140:!!(e&&/\blayout\s*\([^)]*\bstd140\b[^)]*\)/.exec(e))})}return t}function m(e,t=8){if(e.length<=t)return e.join(", ");let i=e.length-t;return`${e.slice(0,t).join(", ")}, ... (${i} more)`}function b(e,t,i="glsl"){let r="";for(let n in e){let s=e[n],a="wgsl"===i?"fn":"void";if(r+=`${a} ${s.signature} {
`,s.header&&(r+=`  ${s.header}`),t[n]){let e=t[n];for(let t of(e.sort((e,t)=>e.order-t.order),e))r+=`  ${t.injection}
`}s.footer&&(r+=`  ${s.footer}`),r+="}\n"}return r}function _(e){let t={vertex:{},fragment:{}};for(let i of e){let e,r;"string"!=typeof i?r=(e=i).hook:(e={},r=i);let n=(r=r.trim()).indexOf(":"),s=r.slice(0,n),a=r.slice(n+1),o=r.replace(/\(.+/,""),u=Object.assign(e,{signature:a});switch(s){case"vs":t.vertex[o]=u;break;case"fs":t.fragment[o]=u;break;default:throw Error(s)}}return t}let y="(?:var<\\s*(uniform|storage(?:\\s*,\\s*[A-Za-z_][A-Za-z0-9_]*)?)\\s*>|var)\\s+([A-Za-z_][A-Za-z0-9_]*)",v=[RegExp(`@binding\\(\\s*(auto|\\d+)\\s*\\)\\s*@group\\(\\s*(\\d+)\\s*\\)\\s*${y}`,"g"),RegExp(`@group\\(\\s*(\\d+)\\s*\\)\\s*@binding\\(\\s*(auto|\\d+)\\s*\\)\\s*${y}`,"g")],w=[RegExp(`@binding\\(\\s*(auto|\\d+)\\s*\\)\\s*@group\\(\\s*(\\d+)\\s*\\)\\s*${y}`,"g"),RegExp(`@group\\(\\s*(\\d+)\\s*\\)\\s*@binding\\(\\s*(auto|\\d+)\\s*\\)\\s*${y}`,"g")],E=[RegExp(`@binding\\(\\s*(\\d+)\\s*\\)\\s*@group\\(\\s*(\\d+)\\s*\\)\\s*${y}`,"g"),RegExp(`@group\\(\\s*(\\d+)\\s*\\)\\s*@binding\\(\\s*(\\d+)\\s*\\)\\s*${y}`,"g")],x=[RegExp(`@binding\\(\\s*(auto)\\s*\\)\\s*@group\\(\\s*(\\d+)\\s*\\)\\s*${y}`,"g"),RegExp(`@group\\(\\s*(\\d+)\\s*\\)\\s*@binding\\(\\s*(auto)\\s*\\)\\s*${y}`,"g"),RegExp(`@binding\\(\\s*(auto)\\s*\\)\\s*@group\\(\\s*(\\d+)\\s*\\)(?:[\\s\\n\\r]*@[A-Za-z_][^\\n\\r]*)*[\\s\\n\\r]*${y}`,"g"),RegExp(`@group\\(\\s*(\\d+)\\s*\\)\\s*@binding\\(\\s*(auto)\\s*\\)(?:[\\s\\n\\r]*@[A-Za-z_][^\\n\\r]*)*[\\s\\n\\r]*${y}`,"g")];function S(e){let t=e.split(""),i=0,r=0,n=!1,s=!1,a=!1;for(;i<e.length;){let o=e[i],u=e[i+1];if(s){a?a=!1:"\\"===o?a=!0:'"'===o&&(s=!1),i++;continue}if(n){"\n"===o||"\r"===o?n=!1:t[i]=" ",i++;continue}if(r>0){if("/"===o&&"*"===u){t[i]=" ",t[i+1]=" ",r++,i+=2;continue}if("*"===o&&"/"===u){t[i]=" ",t[i+1]=" ",r--,i+=2;continue}"\n"!==o&&"\r"!==o&&(t[i]=" "),i++;continue}if('"'===o){s=!0,i++;continue}if("/"===o&&"/"===u){t[i]=" ",t[i+1]=" ",n=!0,i+=2;continue}if("/"===o&&"*"===u){t[i]=" ",t[i+1]=" ",r=1,i+=2;continue}i++}return t.join("")}function A(e,t){let i=S(e),r=[];for(let n of t){let s;for(n.lastIndex=0,s=n.exec(i);s;){let a=n===t[0],o=s.index,u=s[0].length;r.push({match:e.slice(o,o+u),index:o,length:u,bindingToken:s[a?1:2],groupToken:s[a?2:1],accessDeclaration:s[3]?.trim(),name:s[4]}),s=n.exec(i)}}return r.sort((e,t)=>e.index-t.index)}function B(e,t,i){let r=A(e,t);if(!r.length)return e;let n="",s=0;for(let t of r)n+=e.slice(s,t.index),n+=i(t),s=t.index+t.length;return n+e.slice(s)}function L(e){return/@binding\(\s*auto\s*\)/.test(S(e))}let $=[RegExp(`@binding\\(\\s*(\\d+)\\s*\\)\\s*@group\\(\\s*(\\d+)\\s*\\)\\s*${y}\\s*:\\s*([^;]+);`,"g"),RegExp(`@group\\(\\s*(\\d+)\\s*\\)\\s*@binding\\(\\s*(\\d+)\\s*\\)\\s*${y}\\s*:\\s*([^;]+);`,"g")];function T(e,t=[]){let i=S(e),r=new Map;for(let e of t)r.set(M(e.name,e.group,e.location),e.moduleName);let n=[];for(let e of $){let t;for(e.lastIndex=0,t=e.exec(i);t;){let s=e===$[0],a=Number(t[s?1:2]),o=Number(t[s?2:1]),u=t[3]?.trim(),l=t[4],f=t[5].trim(),h=r.get(M(l,o,a));n.push(function(e){var t;let i={name:e.name,group:e.group,binding:e.binding,owner:e.owner,kind:"unknown",moduleName:e.moduleName,resourceType:e.resourceType};if(e.accessDeclaration){let t=e.accessDeclaration.split(",").map(e=>e.trim());if("uniform"===t[0])return{...i,kind:"uniform",access:"uniform"};if("storage"===t[0]){let e=t[1]||"read_write";return{...i,kind:"read"===e?"read-only-storage":"storage",access:e}}}return"sampler"===e.resourceType||"sampler_comparison"===e.resourceType?{...i,kind:"sampler",samplerKind:"sampler_comparison"===e.resourceType?"comparison":"filtering"}:e.resourceType.startsWith("texture_storage_")?{...i,kind:"storage-texture",access:function(e){let t=/,\s*([A-Za-z_][A-Za-z0-9_]*)\s*>$/.exec(e);return t?.[1]}(e.resourceType),viewDimension:P(e.resourceType)}:e.resourceType.startsWith("texture_")?{...i,kind:"texture",viewDimension:P(e.resourceType),sampleType:(t=e.resourceType).startsWith("texture_depth_")?"depth":t.includes("<i32>")?"sint":t.includes("<u32>")?"uint":t.includes("<f32>")?"float":void 0,multisampled:e.resourceType.startsWith("texture_multisampled_")}:i}({name:l,group:o,binding:a,owner:h?"module":"application",moduleName:h,accessDeclaration:u,resourceType:f})),t=e.exec(i)}}return n.sort((e,t)=>e.group!==t.group?e.group-t.group:e.binding!==t.binding?e.binding-t.binding:e.name.localeCompare(t.name))}function M(e,t,i){return`${t}:${i}:${e}`}function P(e){return e.includes("cube_array")?"cube-array":e.includes("2d_array")?"2d-array":e.includes("cube")?"cube":e.includes("3d")?"3d":e.includes("2d")?"2d":e.includes("1d")?"1d":void 0}function O(e,t={}){let i=k(e),r=function(e){let t=[],i=0;for(let r of e){if("}"===r.value&&0===i)return null;t.push(i),"{"===r.value?i++:"}"===r.value&&i--}return 0===i?t:null}(i);if(!r)return null;let n=function(e,t){let i=new Map;for(let r=0;r<e.length;r++){if(0!==t[r]||"alias"!==e[r].value)continue;let n=e[r+1]?.value;if(!j(n)||e[r+2]?.value!=="="||i.has(n))return null;let s=F(e,t,r+3,";");if(s<0||s===r+3)return null;i.set(n,V(e.slice(r+3,s))),r=s}return i}(i,r),s=function(e,t){let i=new Map;for(let r=0;r<e.length;r++){if(0!==t[r]||"struct"!==e[r].value)continue;let n=e[r+1]?.value,s=r+2;if(!j(n)||i.has(n)||e[s]?.value!=="{")return null;let a=U(e,s,"{","}");if(a<0)return null;i.set(n,e.slice(s+1,a)),r=a}return i}(i,r);if(!n||!s)return null;let a=function(e,t,i){let r=[],n=new Set,s=new Set;for(let a=0;a<e.length;a++){if(0!==t[a]||"var"!==e[a].value)continue;let o=z(e,t,a),u=e.slice(o,a),l=R(u,"group"),f=R(u,"binding");if(null===l||null===f||void 0===l!=(void 0===f))return null;if(void 0===l||void 0===f)continue;let h=a+1,c=[];if(e[h]?.value==="<"){let t=U(e,h,"<",">");if(t<0)return null;let i=D(e.slice(h+1,t),",");if(!i)return null;c=i.map(V),h=t+1}let d=e[h]?.value;if(!j(d)||e[h+1]?.value!==":")return null;let p=F(e,t,h+2,";");if(p<0||p===h+2)return null;let g=C(V(e.slice(h+2,p)),i);if(!g)return null;let m=function(e){let{name:t,group:i,location:r,addressSpace:n,resourceType:s}=e,a={name:t,group:i,location:r};if("uniform"===n[0]&&1===n.length)return{...a,type:"uniform"};if("storage"===n[0]&&n.length<=2){let e=n[1]||"read";return"read"===e?{...a,type:"read-only-storage"}:"read_write"===e?{...a,type:"storage"}:null}return n.length>0?null:"sampler"===s||"sampler_comparison"===s?{...a,type:"sampler",..."sampler_comparison"===s?{samplerType:"comparison"}:{}}:"texture_external"===s?{...a,type:"external-texture"}:function(e,t){let i=/^texture_storage_(1d|2d|2d_array|3d)<([A-Za-z0-9_]+),(read|write|read_write)>$/.exec(t);if(!i)return null;let r={read:"read-only",write:"write-only",read_write:"read-write"}[i[3]];return{...e,type:"storage",format:i[2],access:r,viewDimension:N(i[1])}}(a,s)||function(e,t){let i=/^texture_(multisampled_)?(1d|2d|2d_array|cube|cube_array|3d)<(f32|i32|u32)>$/.exec(t);if(i){if(i[1]&&"2d"!==i[2])return null;let t={f32:"float",i32:"sint",u32:"uint"}[i[3]];return{...e,type:"texture",viewDimension:N(i[2]),sampleType:t,multisampled:!!i[1]}}let r=/^texture_depth_(multisampled_)?(2d|2d_array|cube|cube_array)$/.exec(t);return!r||r[1]&&"2d"!==r[2]?null:{...e,type:"texture",viewDimension:N(r[2]),sampleType:"depth",multisampled:!!r[1]}}(a,s)}({name:d,group:l,location:f,addressSpace:c,resourceType:g}),b=`${l}:${f}`;if(!m||n.has(b)||s.has(d))return null;r.push(m),n.add(b),s.add(d),a=p}return function(e){for(let t of e){if("sampler"!==t.type||t.samplerType||!t.name.endsWith("Sampler"))continue;let i=t.name.slice(0,-7),r=e.find(e=>"texture"===e.type&&e.name===i&&e.group===t.group);r?.sampleType==="depth"&&(t.samplerType="non-filtering")}}(r),r.sort((e,t)=>e.group-t.group||e.location-t.location||e.name.localeCompare(t.name))}(i,r,n),o=function(e,t,i,r,n){let s=function(e,t){let i=[],r=new Set;for(let n=0;n<e.length;n++){if(0!==t[n]||"fn"!==e[n].value)continue;let s=e[n+1]?.value,a=n+2;if(!j(s)||r.has(s)||e[a]?.value!=="(")return null;let o=U(e,a,"(",")");if(o<0)return null;let u=z(e,t,n);i.push({name:s,vertex:I(e.slice(u,n),"vertex"),parameters:e.slice(a+1,o)}),r.add(s),n=o}return i}(e,t);if(!s)return null;let a=s.filter(e=>e.vertex),o=n?a.find(e=>e.name===n):1===a.length?a[0]:void 0;if(!o)return 0!==a.length||n?null:[];let u=D(o.parameters,",");if(!u)return null;let l=[],f=new Set,h=new Set,c=new Set;for(let e of u)if(e.length>0&&!function e(t){let{declaration:i,aliases:r,structures:n,attributes:s,attributeLocations:a,attributeNames:o,visitedStructures:u}=t,l=function(e){let t=D(e,":");return t&&2===t.length?t[0].length:-1}(i);if(l<1||l===i.length-1)return!1;let f=function(e){for(let t=e.length-1;t>=0;t--)if(j(e[t].value))return e[t].value;return null}(i.slice(0,l)),h=R(i.slice(0,l),"location"),c=I(i.slice(0,l),"builtin"),d=C(V(i.slice(l+1)),r);if(!f||null===h||!d||void 0!==h&&c)return!1;if(void 0!==h){var p;let e=(p=d,/^(?:i32|u32|f32|f16|vec[234]<(?:i32|u32|f32|f16)>)$/.test(p)?p:null);return!(!e||a.has(h)||o.has(f))&&(s.push({name:f,location:h,type:e}),a.add(h),o.add(f),!0)}if(c)return!0;let g=n.get(d);if(!g||u.has(d))return!1;let m=D(g,",");if(!m)return!1;for(let i of(u.add(d),m))if(i.length>0&&!e({...t,declaration:i}))return!1;return u.delete(d),!0}({declaration:e,aliases:i,structures:r,attributes:l,attributeLocations:f,attributeNames:h,visitedStructures:c}))return null;return l.sort((e,t)=>e.location-t.location||e.name.localeCompare(t.name))}(i,r,n,s,t.vertexEntryPoint);return a&&o?{attributes:o,bindings:a}:null}function k(e){let t=S(e),i=/[A-Za-z_][A-Za-z0-9_]*|(?:0[xX][0-9A-Fa-f]+|\d+)|[@(){}<>\[\]:,;=]/g,r=[],n=i.exec(t);for(;n;)r.push({value:n[0],index:n.index}),n=i.exec(t);return r}function C(e,t,i=new Set){let r=k(e),n="";for(let e of r){let r=t.get(e.value);if(!r){n+=function(e){let t=/^(vec[234]|mat[234]x[234])([fiuh])$/.exec(e);if(!t)return e;let i={f:"f32",i:"i32",u:"u32",h:"f16"}[t[2]];return`${t[1]}<${i}>`}(e.value);continue}if(i.has(e.value))return null;let s=new Set(i);s.add(e.value);let a=C(r,t,s);if(!a)return null;n+=a}return n}function R(e,t){let i;for(let r=0;r<e.length;r++)if("@"===e[r].value&&e[r+1]?.value===t){if(void 0!==i||e[r+2]?.value!=="("||!/^\d+$/.test(e[r+3]?.value||"")||e[r+4]?.value!==")")return null;i=Number(e[r+3].value)}return i}function I(e,t){return e.some((i,r)=>"@"===i.value&&e[r+1]?.value===t)}function N(e){return e.replace("_","-")}function U(e,t,i,r){let n=0;for(let s=t;s<e.length;s++)if(e[s].value===i)n++;else if(e[s].value===r&&0==--n)return s;return -1}function D(e,t){let i=[],r=0,n={"(":0,"<":0,"[":0,"{":0},s=Object.keys(n),a={")":"(",">":"<","]":"[","}":"{"};for(let o=0;o<e.length;o++){let u=e[o].value;if(u===t&&s.every(e=>0===n[e])){i.push(e.slice(r,o)),r=o+1;continue}if(u in n)n[u]++;else if(u in a){let e=a[u];if(n[e]--,n[e]<0)return null}}return s.every(e=>0===n[e])?(i.push(e.slice(r)),i):null}function F(e,t,i,r){for(let n=i;n<e.length;n++)if(0===t[n]&&e[n].value===r)return n;return -1}function z(e,t,i){for(let r=i-1;r>=0;r--)if(";"===e[r].value&&0===t[r]||"}"===e[r].value&&1===t[r])return r+1;return 0}function V(e){return e.map(e=>e.value).join("")}function j(e){return!!(e&&/^[A-Za-z_][A-Za-z0-9_]*$/.test(e))}let G="([a-zA-Z_][a-zA-Z0-9_]*)",W=/^\s*\#\s*if\s+(.+?)\s*(?:\/\/.*)?$/,q=RegExp(`^\\s*\\#\\s*ifdef\\s*${G}\\s*$`),H=RegExp(`^\\s*\\#\\s*ifndef\\s*${G}\\s*(?:\\/\\/.*)?$`),Y=/^\s*\#\s*else\s*(?:\/\/.*)?$/,Z=/^\s*\#\s*endif\s*$/,X=RegExp(`^\\s*\\#\\s*ifdef\\s*${G}\\s*(?:\\/\\/.*)?$`),K=/^\s*\#\s*endif\s*(?:\/\/.*)?$/;function Q(e,t){let i=e.split("\n"),r=[],n=[],s=!0;for(let e of i){let i=e.match(W),a=e.match(X)||e.match(q),o=e.match(H),u=e.match(Y),l=e.match(K)||e.match(Z);if(i){let e=function(e,t){let i=e.trim();if(/^[+-]?\d+(?:\.\d+)?$/.test(i))return 0!==Number(i);if("true"===i)return!0;if("false"===i)return!1;let r=i.match(RegExp(`^!\\s*${G}$`));if(r)return!t[r[1]];let n=i.match(RegExp(`^${G}$`));if(n)return!!t[n[1]];let s=i.match(RegExp(`^defined\\s*\\(\\s*${G}\\s*\\)$`));if(s)return void 0!==t[s[1]];let a=i.match(RegExp(`^!\\s*defined\\s*\\(\\s*${G}\\s*\\)$`));if(a)return void 0===t[a[1]];throw Error(`Unsupported #if expression "${e}"`)}(i[1],t?.defines||{}),r=s&&e;n.push({parentActive:s,branchTaken:e,active:r}),s=r}else if(a||o){let e=(a||o)?.[1],i=!!t?.defines?.[e],r=a?i:!i,u=s&&r;n.push({parentActive:s,branchTaken:r,active:u}),s=u}else if(u){let e=n[n.length-1];if(!e)throw Error("Encountered #else without matching #if, #ifdef or #ifndef");e.active=e.parentActive&&!e.branchTaken,e.branchTaken=!0,s=e.active}else l?(n.pop(),s=!n.length||n[n.length-1].active):s&&r.push(e)}if(n.length>0)throw Error("Unterminated conditional block in shader source");return r.join("\n")}var J=i(44791);function ee(e){let{primitiveType:t,components:i}=J.Co.getAttributeShaderTypeInfo(e),r="i32"===t?"int":"u32"===t?"uint":"float";return 1===i?r:`${"int"===r?"i":"uint"===r?"u":""}vec${i}`}function et(e){let t=[],i=/@location\s*\(\s*(\d+)\s*\)/g,r=i.exec(e);for(;r;)t.push(Number(r[1])),r=i.exec(e);return t}function ei(e){let t=[],i=/(?:^|,)\s*(?:@[A-Za-z_][\w]*(?:\([^)]*\))?\s*)*([A-Za-z_][\w]*)\s*:/gm,r=i.exec(e);for(;r;)t.push(r[1]),r=i.exec(e);return t}function er(e,t,i,r){let n=0,s=0,a=!1;for(let o=t;o<e.length;o++){let t=e[o],u=e[o+1];if(a){"\n"===t&&(a=!1);continue}if(s>0){"/"===t&&"*"===u?(s++,o++):"*"===t&&"/"===u&&(s--,o++);continue}if("/"===t&&"/"===u){a=!0,o++;continue}if("/"===t&&"*"===u){s=1,o++;continue}if(t===i&&n++,t===r&&0==--n)return o}return -1}function en(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function es(e,t,i){let r=RegExp(`\\bfn\\s+${ec(t)}\\s*\\(`,"g").exec(e);if(!r)throw Error(`ShaderPlugin varyings require WGSL ${i} entry point "${t}"`);let n=e.indexOf("(",r.index),s=eh(e,n,"(",")"),a=e.indexOf("{",s),o=eh(e,a,"{","}");if(s<0||a<0||o<0)throw Error(`Unable to parse WGSL ${i} entry point "${t}"`);return{openParenthesis:n,closeParenthesis:s,openBrace:a,closeBrace:o,parameters:e.slice(n+1,s)}}function ea(e,t){let i=eo(e,t);if(!i)throw Error(`Unable to find WGSL stage I/O struct "${t}"`);return i}function eo(e,t){let i=RegExp(`\\bstruct\\s+${ec(t)}\\s*\\{`,"g").exec(e);if(!i)return null;let r=e.indexOf("{",i.index),n=eh(e,r,"{","}");return n<0?null:{openBrace:r,closeBrace:n,body:e.slice(r+1,n)}}function eu(e,t,i){let r=t;if("/"===e[r]&&"/"===e[r+1]){let t=e.indexOf("\n",r+2);return t<0||t>i?i:t+1}if("/"===e[r]&&"*"===e[r+1]){let t=1;for(r+=2;r<i&&t>0;)"/"===e[r]&&"*"===e[r+1]?(t++,r+=2):"*"===e[r]&&"/"===e[r+1]?(t--,r+=2):r++}return r}function el(e){let t=[],i=/@location\s*\(\s*(\d+)\s*\)/g,r=i.exec(e);for(;r;)t.push(Number(r[1])),r=i.exec(e);return t}function ef(e){let t=[],i=/(?:^|,)\s*(?:@[A-Za-z_][\w]*(?:\([^)]*\))?\s*)*([A-Za-z_][\w]*)\s*:/gm,r=i.exec(e);for(;r;)t.push(r[1]),r=i.exec(e);return t}function eh(e,t,i,r){let n=0,s=0,a=!1;for(let o=t;o<e.length;o++){let t=e[o],u=e[o+1];if(a){"\n"===t&&(a=!1);continue}if(s>0){"/"===t&&"*"===u?(s++,o++):"*"===t&&"/"===u&&(s--,o++);continue}if("/"===t&&"/"===u){a=!0,o++;continue}if("/"===t&&"*"===u){s=1,o++;continue}if(t===i&&n++,t===r&&0==--n)return o}return -1}function ec(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}let ed=`

${s.O_}
`,ep=`\
precision highp float;
`;function eg(e,t){let{source:i,stage:n,language:a="glsl",modules:f,defines:c={},hookFunctions:d=[],inject:p={},pluginInjections:m={},pluginVertexInputs:y={},pluginVaryings:v={},prologue:w=!0,log:E}=t;h("string"==typeof i,"shader source must be a string");let x="glsl"===a?({name:function(e,t="unnamed"){let i=/#define[^\S\r\n]*SHADER_NAME[^\S\r\n]*([A-Za-z0-9_-]+)\s*/.exec(e);return i?i[1]:t}(i,void 0),language:"glsl",version:function(e){let t=100,i=e.match(/[^\s]+/g);if(i&&i.length>=2&&"#version"===i[0]){let e=parseInt(i[1],10);Number.isFinite(e)&&(t=e)}if(100!==t&&300!==t)throw Error(`Invalid GLSL version ${t}`);return t}(i)}).version:-1,S=e.shaderLanguageVersion,A=100===x?"#version 100":"#version 300 es",B=i.split("\n").slice(1).join("\n"),L={};f.forEach(e=>{Object.assign(L,e.defines)}),Object.assign(L,c);let $="";switch(a){case"wgsl":break;case"glsl":$=w?`\
${A}
...
`:`${A}
`}let T=_(d),M={},P={},O={};for(let e in eb(m,M,P,O),p){let t="string"==typeof p[e]?{injection:p[e],order:0}:p[e],i=/^(v|f)s:(#)?([\w-]+)$/.exec(e);if(i){let r=i[2],n=i[3];r?"decl"===n?P[e]=[t]:O[e]=[t]:M[e]=[t]}else O[e]=[t]}if("vertex"===n){let e=function(e,t){let i=[];for(let[r,n]of Object.entries(t))(function(e,t){let i=en(t);if(RegExp(`\\b(?:in|attribute)\\s+(?:(?:lowp|mediump|highp)\\s+)?[A-Za-z_][A-Za-z0-9_]*\\s+${i}\\s*(?:\\[|;)`).test(e))throw Error(`ShaderPlugin vertex input "${t}" conflicts with an existing GLSL input`)})(e,r),i.push(`in ${ee(n)} ${r};`);return i.join("\n")}(B,y);e&&(P["vs:#decl"]=P["vs:#decl"]||[],P["vs:#decl"].push({injection:e,order:Number.MIN_SAFE_INTEGER}))}let k=function(e,t,i){let r=[],n=[];for(let[o,u]of Object.entries(i)){var s=e,a=o;if(RegExp(`\\b(?:flat\\s+|smooth\\s+)?(?:in|out|varying)\\s+(?:(?:lowp|mediump|highp)\\s+)?[A-Za-z_][A-Za-z0-9_]*\\s+${ec(a)}\\s*(?:\\[|;)`).test(s))throw Error(`ShaderPlugin varying "${a}" conflicts with existing GLSL stage I/O`);let i="flat"===u.interpolation?"flat ":"",l="vertex"===t?"out":"in";r.push(`${i}${l} ${ee(u.type)} ${o};`),"vertex"===t&&n.push(`${o} = ${function(e){let{primitiveType:t,components:i}=J.Co.getAttributeShaderTypeInfo(e),r="u32"===t?"0u":"i32"===t?"0":"0.0";return 1===i?r:`${ee(e)}(${r})`}(u.type)};`)}return{declarations:r.join("\n"),initialization:n.join("\n")}}(B,n,v);if(k.declarations){let e="vertex"===n?"vs:#decl":"fs:#decl";P[e]=P[e]||[],P[e].push({injection:k.declarations,order:Number.MIN_SAFE_INTEGER})}for(let e of(k.initialization&&(O["vs:#main-start"]=O["vs:#main-start"]||[],O["vs:#main-start"].push({injection:k.initialization,order:Number.MIN_SAFE_INTEGER})),f)){E&&(0,r.ZG)(e,B,E),$+=e_(e,n,E);let t=e.instance?.normalizedInjections[n]||{};for(let e in t){let i=/^(v|f)s:#([\w-]+)$/.exec(e);if(i){let r="decl"===i[2]?P:O;r[e]=r[e]||[],r[e].push(t[e])}else M[e]=M[e]||[],M[e].push(t[e])}}return $+="// ----- MAIN SHADER SOURCE -------------------------",$+=ed,$=(0,s.bv)($,n,P)+b(T[n],M)+B,$=(0,s.bv)($,n,O),"glsl"===a&&x!==S&&($=function(e,t){if(300!==Number(e.match(/^#version[ \t]+(\d+)/m)?.[1]||100))throw Error("luma.gl v9 only supports GLSL 3.00 shader sources");switch(t){case"vertex":return l(e,o);case"fragment":return l(e,u);default:throw Error(t)}}($,n)),"glsl"===a&&function(e,t,i){let r=g(e).filter(e=>!e.isStd140),n=new Set;for(let e of r){if(n.has(e.blockName))continue;n.add(e.blockName);let r=e.hasLayoutQualifier?`declares ${e.layoutQualifier.replace(/\s+/g," ").trim()} instead of layout(std140)`:"does not declare layout(std140)",s=`${t} shader uniform block ${e.blockName} ${r}. luma.gl host-side shader block packing assumes explicit layout(std140) for GLSL uniform blocks. Add \`layout(std140)\` to the block declaration.`;i?.warn?.(s,e)()}}($,n,E),$.trim()}function em(e){return function(t){let i={};for(let r of e){let e=r.getUniforms?.(t,i);Object.assign(i,e)}return i}}function eb(e,t,i,r){for(let n in e){let s=/^(v|f)s:(#)?([\w-]+)$/.exec(n);if(s){let a=s[2],o=s[3],u=a?"decl"===o?i:r:t;u[n]=u[n]||[],u[n].push(...e[n])}else r[n]=r[n]||[],r[n].push(...e[n])}}function e_(e,t,i){let r;switch(t){case"vertex":r=e.vs||"";break;case"fragment":r=e.fs||"";break;case"wgsl":r=e.source||"";break;default:h(!1)}if(!e.name)throw Error("Shader module must have a name");!function(e,t,i={}){let r=function(e,t){let i,r=Object.keys(e.uniformTypes||{});if(!r.length)return null;let n=(i="wgsl"===t?e.source:"vertex"===t?e.vs:e.fs)?function(e,t,i){var r,n;let s,a="wgsl"===t?function(e,t){let i=RegExp(`\\bstruct\\s+${t}\\b`,"m").exec(e);if(!i)return null;let r=e.indexOf("{",i.index);if(r<0)return null;let n=0;for(let t=r;t<e.length;t++){let i=e[t];if("{"===i){n++;continue}if("}"===i&&0==--n)return e.slice(r+1,t)}return null}(e,i):(r=e,n=i,s=g(r).find(e=>e.blockName===n),s?.body||null);if(!a)return null;let o=[];for(let e of a.split("\n")){let i=e.replace(/\/\/.*$/,"").trim();if(!i||i.startsWith("#"))continue;let r="wgsl"===t?i.match(/^([A-Za-z0-9_]+)\s*:/):i.match(c);r&&o.push(r[1])}return o}(i,"wgsl"===t?"wgsl":"glsl",p(e)):null;return n?{moduleName:e.name,uniformBlockName:p(e),stage:t,expectedUniformNames:r,actualUniformNames:n,matches:function(e,t){if(e.length!==t.length)return!1;for(let i=0;i<e.length;i++)if(e[i]!==t[i])return!1;return!0}(r,n)}:null}(e,t);if(!r||r.matches)return;let n=function(e){let{expectedUniformNames:t,actualUniformNames:i}=e,r=t.filter(e=>!i.includes(e)),n=i.filter(e=>!t.includes(e)),s=[`Expected ${t.length} fields, found ${i.length}.`],a=function(e,t){let i=Math.min(e.length,t.length);for(let r=0;r<i;r++)if(e[r]!==t[r])return`First mismatch at field ${r+1}: expected ${e[r]}, found ${t[r]}.`;return e.length>t.length?`Shader block ends after field ${t.length}; expected next field ${e[t.length]}.`:t.length>e.length?`Shader block has extra field ${t.length}: ${t[e.length]}.`:null}(t,i);return a&&s.push(a),r.length&&s.push(`Missing from shader block (${r.length}): ${m(r)}.`),n.length&&s.push(`Unexpected in shader block (${n.length}): ${m(n)}.`),t.length<=12&&i.length<=12&&(r.length||n.length)&&(s.push(`Expected: ${t.join(", ")}.`),s.push(`Actual: ${i.join(", ")}.`)),`${e.moduleName}: ${e.stage} shader uniform block ${e.uniformBlockName} does not match module.uniformTypes. ${s.join(" ")}`}(r);i.log?.error?.(n,r)(),!1!==i.throwOnError&&h(!1,n)}(e,t,{log:i});let n=e.name.toUpperCase().replace(/[^0-9a-z]/gi,"_"),s=`\
// ----- MODULE ${e.name} ---------------

`;return"wgsl"!==t&&(s+=`#define MODULE_${n}
`),s+=`${r}
`}function ey(e,t,i){if(0===e&&t>=100)throw Error(`Application binding "${i}" in group 0 uses reserved binding ${t}. Application-owned explicit group-0 bindings must stay below 100.`)}function ev(e,t,i,r){if(0===t&&i<100)throw Error(`Module "${e}" binding "${r}" in group 0 uses reserved application binding ${i}. Module-owned explicit group-0 bindings must be 100 or higher.`)}function ew(e,t,i,r){let n=e.get(t)||new Set;if(n.has(i))throw Error(`Duplicate WGSL binding assignment for ${r}: group ${t}, binding ${i}.`);n.add(i),e.set(t,n)}function eE(e,t,i){let r=t.get(e)||new Set,n=i??(0===e?100:r.size>0?Math.max(...r)+1:0);for(;r.has(n);)n++;return n}function ex(e,t,i){return`${e}:${t}:${i}`}class eS{static defaultShaderAssembler;_hookFunctions=[];_defaultModules=[];_wgslBindingRegistry=new Map;static getDefaultShaderAssembler(){return eS.defaultShaderAssembler=eS.defaultShaderAssembler||new eS,eS.defaultShaderAssembler}addDefaultModule(e){this._defaultModules.find(t=>t.name===("string"==typeof e?e:e.name))||this._defaultModules.push(e)}removeDefaultModule(e){let t="string"==typeof e?e:e.name;this._defaultModules=this._defaultModules.filter(e=>e.name!==t)}addShaderHook(e,t){t&&(e=Object.assign(t,{hook:e})),this._hookFunctions.push(e)}assembleWGSLShader(e){var t,i,a;let o,u=this._getModuleList(e.modules),l=this._hookFunctions,f=(t=e,i=u,{...(o=(a=t.platformInfo).limits||{},{LUMA_SUPPORTS_VERTEX_STORAGE_BUFFERS:"webgpu"===a.type&&(o.maxStorageBuffersInVertexStage||0)>0,LUMA_FP64_INTEGER_ARITHMETIC:"webgpu"===a.type&&"apple"===a.gpu.toLowerCase()}),...i.reduce((e,t)=>(Object.assign(e,t.defines),e),{}),...t.defines}),c="wgsl"===e.platformInfo.shaderLanguage&&e.source?Q(e.source,{defines:f}):e.source,{source:d,getUniforms:p,bindingAssignments:g}=function(e){let t=(0,n.$Q)(e.modules||[]),{source:i,bindingAssignments:a}=function(e,t){var i,n,a,o,u,l,f,c,d,p,g;let m,{source:y,stage:S,modules:$,defines:T={},hookFunctions:M=[],inject:P={},pluginInjections:O={},pluginVertexInputs:k={},pluginVaryings:C={},vertexEntryPoint:R="vertexMain",fragmentEntryPoint:I="fragmentMain",log:N}=t;h("string"==typeof y,"shader source must be a string");let U=function(e,t,i){let r=Object.entries(i);if(0===r.length)return{source:e,declarations:"",initialization:""};let n=function(e,t){let i=RegExp(`\\bfn\\s+${en(t)}\\s*\\(`,"g").exec(e);if(!i)throw Error(`ShaderPlugin vertex inputs require WGSL vertex entry point "${t}"`);let r=e.indexOf("(",i.index),n=er(e,r,"(",")");if(n<0)throw Error(`Unable to parse WGSL vertex entry point "${t}" parameters`);return{openParenthesis:r,closeParenthesis:n}}(e,t),s=e.slice(n.openParenthesis+1,n.closeParenthesis),a=function(e,t){let i=et(t),r=new Set(ei(t));for(let n of function(e){let t=[],i=/:\s*([A-Za-z_][\w]*)\b/g,r=i.exec(e);for(;r;)t.push(r[1]),r=i.exec(e);return t}(t)){let t=function(e,t){let i=RegExp(`\\bstruct\\s+${en(t)}\\s*\\{`,"g").exec(e);if(!i)return null;let r=e.indexOf("{",i.index),n=er(e,r,"{","}");return n<0?null:e.slice(r+1,n)}(e,n);if(null!==t)for(let e of(i.push(...et(t)),ei(t)))r.add(e)}return{locations:i,names:r}}(e,s),o=new Set(a.locations),u=[],l=[],f=[];for(let[t,i]of r){if(a.names.has(t)||function(e,t){let i=en(t),r=RegExp(`\\b(?:var(?:<[^>]+>)?|let|const)\\s+${i}\\b`,"g"),n=r.exec(e);for(;n;){if(0===function(e,t){let i=0,r=0,n=!1;for(let s=0;s<t;s++){let t=e[s],a=e[s+1];if(n){"\n"===t&&(n=!1);continue}if(r>0){"/"===t&&"*"===a?(r++,s++):"*"===t&&"/"===a&&(r--,s++);continue}"/"===t&&"/"===a?(n=!0,s++):"/"===t&&"*"===a?(r=1,s++):"{"===t?i++:"}"===t&&i--}return i}(e,n.index))return!0;n=r.exec(e)}return!1}(e,t))throw Error(`ShaderPlugin vertex input "${t}" conflicts with an existing WGSL shader input or variable`);let r=function(e){let t=0;for(;e.has(t);)t++;return t}(o);o.add(r);let n=`_luma_${t}`;u.push(`@location(${r}) ${n}: ${i}`),l.push(`var<private> ${t}: ${i};`),f.push(`${t} = ${n};`)}let h=s.trim()?",\n  ":"\n  ",c=s.trim()?"":"\n",d=`${s}${h}${u.join(",\n  ")}${c}`;return{source:e.slice(0,n.openParenthesis+1)+d+e.slice(n.closeParenthesis),declarations:l.join("\n"),initialization:f.join("\n")}}(Q(y,{defines:T}),R,k),D=function(e,t,i,r){let n=Object.entries(r);if(0===n.length)return{source:e,declarations:"",vertexInitialization:"",fragmentInitialization:""};let s=e,a=es(s,t,"vertex"),o=function(e,t){let i=e.slice(t.closeParenthesis+1,t.openBrace),r=/->\s*([A-Za-z_][\w]*)\s*$/.exec(i.trim());if(!r||null===eo(e,r[1]))throw Error("ShaderPlugin varyings require the WGSL vertex entry point to return a named struct");return r[1]}(s,a),u=es(s,i,"fragment"),l=function(e,t){let i=[];for(let r of function(e){let t=[],i=0,r=0,n=0;for(let s=0;s<e.length;s++){let a=e[s];"("===a&&r++,")"===a&&r--,"<"===a&&n++,">"===a&&n--,","===a&&0===r&&0===n&&(t.push(e.slice(i,s)),i=s+1)}return t.push(e.slice(i)),t}(t.parameters)){let t=/(?:@[A-Za-z_][\w]*(?:\([^)]*\))?\s*)*([A-Za-z_][\w]*)\s*:\s*([A-Za-z_][\w]*)\s*$/.exec(r.trim());t&&eo(e,t[2])&&i.push({name:t[1],type:t[2]})}if(1!==i.length)throw Error(`ShaderPlugin varyings require exactly one named WGSL fragment input struct; found ${i.length}`);return i[0]}(s,u),f=ea(s,o),h=ea(s,l.type),c=new Set([...ef(a.parameters),...ef(f.body),...ef(u.parameters),...ef(h.body)]),d=new Set([...el(f.body),...el(h.body)]),p=[],g=[],m=[],b=[];for(let[e,t]of n){if(c.has(e)||function(e,t){let i=RegExp(`\\b(?:var(?:<[^>]+>)?|let|const)\\s+${ec(t)}\\b`,"g"),r=i.exec(e);for(;r;){if(0===function(e,t){let i=0;for(let r=0;r<t;r++){let n=eu(e,r,t);if(n!==r){r=n-1;continue}"{"===e[r]&&i++,"}"===e[r]&&i--}return i}(e,r.index))return!0;r=i.exec(e)}return!1}(s,e))throw Error(`ShaderPlugin varying "${e}" conflicts with existing WGSL stage I/O or a module variable`);let i=function(e){let t=0;for(;e.has(t);)t++;return t}(d);d.add(i);let r="flat"===t.interpolation?" @interpolate(flat)":"";p.push(`  @location(${i})${r} ${e}: ${t.type},`),g.push(`var<private> ${e}: ${t.type};`),m.push(`${e} = ${function(e){let{primitiveType:t,components:i}=J.Co.getAttributeShaderTypeInfo(e),r=`${t}(0)`;return 1===i?r:`${e}(${r})`}(t.type)};`),b.push(`${e} = ${l.name}.${e};`)}for(let e of(function(e,t,i,r){let n=RegExp(`\\b${ec(t)}\\s*\\(`,"g"),s=n.exec(e);for(;s;){if(s.index<i||s.index>r)throw Error(`ShaderPlugin varying output struct "${t}" is constructed outside the selected vertex entry point`);s=n.exec(e)}}(s,o,a.openBrace,a.closeBrace),a=es(s=function(e,t,i,r){let n=RegExp(`\\b${ec(t)}\\s*\\(`,"g"),s=[],a=n.exec(e);for(;a;){if(a.index>i.openBrace&&a.index<i.closeBrace){let r=e.indexOf("(",a.index),n=eh(e,r,"(",")");if(n<0||n>i.closeBrace)throw Error(`Unable to parse WGSL output constructor "${t}"`);s.push({openParenthesis:r,closeParenthesis:n})}a=n.exec(e)}for(let t of s.sort((e,t)=>t.closeParenthesis-e.closeParenthesis)){let i=e.slice(t.openParenthesis+1,t.closeParenthesis).trim()?", ":"";e=e.slice(0,t.closeParenthesis)+i+r.join(", ")+e.slice(t.closeParenthesis)}return e}(s,o,a,n.map(([e])=>e)),t,"vertex"),s=function(e,t,i){let r=function(e,t,i){let r=[],n=t;for(;n<i;)if(n=eu(e,n,i),"return"!==e.slice(n,n+6)||/[A-Za-z0-9_]/.test(e[n+6]||""))n++;else{let t=n+6,s=function(e,t,i){let r=0,n=0;for(let s=t;s<i;s++){let t=eu(e,s,i);if(t!==s){s=t-1;continue}let a=e[s];if("("===a&&r++,")"===a&&r--,"["===a&&n++,"]"===a&&n--,";"===a&&0===r&&0===n)return s}return -1}(e,t,i);if(s<0)throw Error("Unable to parse WGSL return statement in selected vertex entry point");r.push({start:n,expressionStart:t,semicolon:s}),n=s+1}return r}(e,t.openBrace+1,t.closeBrace);for(let t=r.length-1;t>=0;t--){let n=r[t],s=e.slice(n.expressionStart,n.semicolon).trim();if(!s)throw Error("ShaderPlugin varying vertex entry point cannot use an empty return");let a=`_luma_vertexOutput${t}`,o=i.map(e=>`${a}.${e} = ${e};`).join("\n"),u=`{
var ${a} = ${s};
${o}
return ${a};
}`;e=e.slice(0,n.start)+u+e.slice(n.semicolon+1)}return e}(s,a,n.map(([e])=>e)),(o===l.type?[o]:[o,l.type]).map(e=>ea(s,e).closeBrace).sort((e,t)=>t-e)))s=s.slice(0,e)+`${p.join("\n")}
`+s.slice(e);if(u=es(s,i,"fragment"),!RegExp(`\\b${ec(l.name)}\\s*:`).test(u.parameters))throw Error(`Unable to preserve WGSL fragment input "${l.name}"`);return{source:s,declarations:g.join("\n"),vertexInitialization:m.join("\n"),fragmentInitialization:b.join("\n")}}(U.source,R,I,C),F=D.source,z="",V=_(M),j={},G={},W={};for(let e in eb(O,j,G,W),P){let t="string"==typeof P[e]?{injection:P[e],order:0}:P[e],i=/^(v|f)s:(#)?([\w-]+)$/.exec(e);if(i){let r=i[2],n=i[3];r?"decl"===n?G[e]=[t]:W[e]=[t]:j[e]=[t]}else W[e]=[t]}i=U.declarations,n=U.initialization,a=G,o=W,i&&(a["vs:#decl"]=a["vs:#decl"]||[],a["vs:#decl"].push({injection:i,order:Number.MIN_SAFE_INTEGER})),n&&(o["vs:#main-start"]=o["vs:#main-start"]||[],o["vs:#main-start"].push({injection:n,order:Number.MIN_SAFE_INTEGER})),u=D,l=G,f=W,u.declarations&&(l["vs:#decl"]=l["vs:#decl"]||[],l["vs:#decl"].push({injection:u.declarations,order:Number.MIN_SAFE_INTEGER})),u.vertexInitialization&&(f["vs:#main-start"]=f["vs:#main-start"]||[],f["vs:#main-start"].push({injection:u.vertexInitialization,order:Number.MIN_SAFE_INTEGER})),u.fragmentInitialization&&(f["fs:#main-start"]=f["fs:#main-start"]||[],f["fs:#main-start"].push({injection:u.fragmentInitialization,order:Number.MIN_SAFE_INTEGER}));let q=function(e){let t=A(e,w),i=new Map;for(let e of t){if("auto"===e.bindingToken)continue;let t=Number(e.bindingToken),r=Number(e.groupToken);ey(r,t,e.name),ew(i,r,t,`application binding "${e.name}"`)}let r={sawSupportedBindingDeclaration:t.length>0},n=B(e,w,e=>(function(e,t,i){let{match:r,bindingToken:n,groupToken:s,name:a}=e,o=Number(s);if("auto"===n){let e=function(e,t){let i=t.get(e)||new Set,r=0;for(;i.has(r);)r++;return r}(o,t);return ey(o,e,a),ew(t,o,e,`application binding "${a}"`),r.replace(/@binding\(\s*auto\s*\)/,`@binding(${e})`)}return i.sawSupportedBindingDeclaration=!0,r})(e,i,r));if(L(e)&&!r.sawSupportedBindingDeclaration)throw Error('Unsupported @binding(auto) declaration form in application WGSL. Use adjacent "@group(N)" and "@binding(auto)" decorators followed by a bindable "var" declaration.');return{source:n}}(F),H=function(e){let t=new Map;for(let i of A(e,E)){let e=Number(i.bindingToken),r=Number(i.groupToken);ey(r,e,i.name),ew(t,r,e,`application binding "${i.name}"`)}return t}(q.source),Y=function(e,t,i,r){let n=new Map;if(!t)return n;for(let s of e)for(let e of function(e,t){let i=[];for(let r of A(Q(e.source||"",{defines:t}),v))i.push({name:r.name,group:Number(r.groupToken)});return i}(s,r)){let r=ex(e.group,s.name,e.name),a=t.get(r);if(void 0!==a){let t=n.get(e.group)||new Map,s=t.get(a);if(s&&s!==r)throw Error(`Duplicate WGSL binding reservation for modules "${s}" and "${r}": group ${e.group}, binding ${a}.`);ew(i,e.group,a,`registered module binding "${r}"`),t.set(a,r),n.set(e.group,t)}}return n}($,t._bindingRegistry,H,T),Z=[];for(let e of $){N&&(0,r.ZG)(e,F,N);let i=function(e,t,i){let r=[],n={sawSupportedBindingDeclaration:A(e,v).length>0,nextHintedBindingLocation:"number"==typeof t.firstBindingSlot?t.firstBindingSlot:null},s=B(e,v,e=>(function(e,t){let{module:i,context:r,bindingAssignments:n,relocationState:s}=t,{match:a,bindingToken:o,groupToken:u,name:l}=e,f=Number(u);if("auto"===o){let e=ex(f,i.name,l),t=r.bindingRegistry?.get(e),o=void 0!==t?t:null===s.nextHintedBindingLocation?eE(f,r.usedBindingsByGroup):eE(f,r.usedBindingsByGroup,s.nextHintedBindingLocation);return(ev(i.name,f,o,l),void 0!==t&&function(e,t,i,r){let n=e.get(t);if(!n)return!1;let s=n.get(i);if(!s)return!1;if(s!==r)throw Error(`Registered module binding "${r}" collided with "${s}": group ${t}, binding ${i}.`);return!0}(r.reservedBindingKeysByGroup,f,o,e))?n.push({moduleName:i.name,name:l,group:f,location:o}):(ew(r.usedBindingsByGroup,f,o,`module "${i.name}" binding "${l}"`),r.bindingRegistry?.set(e,o),n.push({moduleName:i.name,name:l,group:f,location:o}),null!==s.nextHintedBindingLocation&&void 0===t&&(s.nextHintedBindingLocation=o+1)),a.replace(/@binding\(\s*auto\s*\)/,`@binding(${o})`)}let h=Number(o);return ev(i.name,f,h,l),ew(r.usedBindingsByGroup,f,h,`module "${i.name}" binding "${l}"`),n.push({moduleName:i.name,name:l,group:f,location:h}),a})(e,{module:t,context:i,bindingAssignments:r,relocationState:n}));if(L(e)&&!n.sawSupportedBindingDeclaration)throw Error(`Unsupported @binding(auto) declaration form in module "${t.name}". Use adjacent "@group(N)" and "@binding(auto)" decorators followed by a bindable "var" declaration.`);return{source:s,bindingAssignments:r}}(Q(e_(e,"wgsl",N),{defines:T}),e,{usedBindingsByGroup:H,bindingRegistry:t._bindingRegistry,reservedBindingKeysByGroup:Y});Z.push(...i.bindingAssignments),z+=i.source;let n=(c=e,{...c.instance?.normalizedInjections.vertex||{},...c.instance?.normalizedInjections.fragment||{}});for(let e in n){let t=/^(v|f)s:#([\w-]+)$/.exec(e);if(t){let i="decl"===t[2]?G:W;i[e]=i[e]||[],i[e].push(n[e])}else j[e]=j[e]||[],j[e].push(n[e])}}return z+=ed,z=(0,s.bv)(z,S,(m=[...(d=G)["vs:#decl"]||[],...d["fs:#decl"]||[]]).length?{"vs:#decl":m}:{},!1,"wgsl",{vertex:R,fragment:I})+(p=V,g=j,b(p.vertex,g,"wgsl")+b(p.fragment,g,"wgsl"))+function(e){if(0===e.length)return"";let t="// ----- MODULE WGSL BINDING ASSIGNMENTS ---------------\n";for(let i of e)t+=`// ${i.moduleName}.${i.name} -> @group(${i.group}) @binding(${i.location})
`;return t+"\n"}(Z)+q.source,function(e){var t,i;let r,n=A(e,v==v||v===w?x:v).find(e=>"auto"===e.bindingToken);if(!n)return;let s=function(e,t){let i,r,n=/^\/\/ ----- MODULE ([^\n]+) ---------------$/gm;for(r=n.exec(e);r&&r.index<=t;)i=r[1],r=n.exec(e);return i}(e,n.index);if(s)throw Error(`Unresolved @binding(auto) for module "${s}" binding "${n.name}" remained in assembled WGSL source.`);if(t=e,i=n.index,!((r=t.indexOf(ed))>=0)||i>r)throw Error(`Unresolved @binding(auto) for application binding "${n.name}" remained in assembled WGSL source.`);throw Error(`Unresolved @binding(auto) remained in assembled WGSL source near "${n.match.replace(/\s+/g," ").trim()}".`)}(z=(0,s.bv)(z,S,W,!1,"wgsl",{vertex:R,fragment:I})),{source:z,bindingAssignments:Z}}(e.platformInfo,{...e,source:e.source,stage:"vertex",modules:t});return{source:i,getUniforms:em(t),bindingAssignments:a,bindingTable:T(i,a),shaderLayout:O(i,{vertexEntryPoint:e.vertexEntryPoint})}}({...e,source:c,defines:f,_bindingRegistry:this._wgslBindingRegistry,modules:u,hookFunctions:l}),m="wgsl"===e.platformInfo.shaderLanguage?Q(d,{defines:f}):d;return{source:m,getUniforms:p,modules:u,bindingAssignments:g,bindingTable:T(m,g),shaderLayout:O(m,{vertexEntryPoint:e.vertexEntryPoint})}}assembleGLSLShaderPair(e){let t=this._getModuleList(e.modules),i=this._hookFunctions;return{...function(e){let{vs:t,fs:i}=e,r=(0,n.$Q)(e.modules||[]);return{vs:eg(e.platformInfo,{...e,source:t,stage:"vertex",modules:r}),fs:eg(e.platformInfo,{...e,source:i,stage:"fragment",modules:r}),getUniforms:em(r)}}({...e,vs:e.vs,fs:e.fs,modules:t,hookFunctions:i}),modules:t}}_getModuleList(e=[]){let t=Array(this._defaultModules.length+e.length),i={},n=0;for(let e=0,r=this._defaultModules.length;e<r;++e){let r=this._defaultModules[e],s=r.name;t[n++]=r,i[s]=!0}for(let r=0,s=e.length;r<s;++r){let s=e[r],a=s.name;i[a]||(t[n++]=s,i[a]=!0)}return t.length=n,(0,r.$g)(t),t}}},31770(e,t,i){i.d(t,{O_:()=>o,bv:()=>l,Uu:()=>u});let r={vertex:`\
