...
Points.read = function (pbf, end) {
  return pbf.readFields(
    Points._readField,
    {positions: null, globalFeatureIds: null, featureIds: null},
    end
  );
};
...
Lines.read = function (pbf, end) {
  return pbf.readFields(
    Lines._readField,
    {positions: null, pathIndices: null, featureIds: null},
    end
  );
};
...
Polygons.read = function (pbf, end) {
  return pbf.readFields(
    Polygons._readField,
    {positions: null, polygonIndices: null, featureIds: null, primitivePolygonIndices: null},
    end
  );
};
