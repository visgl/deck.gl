...
Coords._readField = function (tag, obj, pbf) {
  if (tag === 1) {
    var entry = Coords._FieldEntry1.read(pbf, pbf.readVarint() + pbf.pos);
...
NumericProp._readField = function (tag, obj, pbf) {
  if (tag === 1) {
    var entry = NumericProp._FieldEntry1.read(pbf, pbf.readVarint() + pbf.pos);
    obj.value[entry.key] = entry.value;
  }
};
...
Points._readField = function (tag, obj, pbf) {
  if (tag === 1) obj.positions = Coords.read(pbf, pbf.readVarint() + pbf.pos);
    ...
    var entry = Points._FieldEntry5.read(pbf, pbf.readVarint() + pbf.pos);
...
Lines._readField = function (tag, obj, pbf) {
  if (tag === 1) obj.positions = Coords.read(pbf, pbf.readVarint() + pbf.pos);
    ...
    var entry = Lines._FieldEntry6.read(pbf, pbf.readVarint() + pbf.pos);
    obj.numericProps[entry.key] = entry.value;
  }
};
...
Polygons._readField = function (tag, obj, pbf) {
  if (tag === 1) obj.positions = Coords.read(pbf, pbf.readVarint() + pbf.pos);
    ...
    var entry = Polygons._FieldEntry7.read(pbf, pbf.readVarint() + pbf.pos);
    obj.numericProps[entry.key] = entry.value;
  }
};
