...
const ARROW_URL = 'modules/gpu-table/test/data/simple.arrow';
...
test.only('GPUTable#construct(ArrowTable)', async t => {
  const arrowTable = await load(ARROW_URL, ArrowLoader, {worker: false});
