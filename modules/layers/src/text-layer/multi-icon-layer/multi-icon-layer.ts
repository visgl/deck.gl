...
> {
  ...
  initializeState() {
    ...
    // Pack non-fp64 per-glyph attributes into one shared buffer. Positions stay separate
    // because they may require fp64 emulation and are not currently shareable.
