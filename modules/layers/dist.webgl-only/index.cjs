...
function createPropsPrototypeAndTypes(componentClass, extensions) {
  ...
  const defaultProps17 = Object.assign(
...
function interpolateQuad(quad, ut, vt) {
  return (0, import_core14.lerp)((0, import_core14.lerp)(quad[0], quad[1], vt), (0, import_core14.lerp)(quad[3], quad[2], vt), ut);
}
  ...
  _getCoordinateUniforms() {
    ...
    if (imageCoordinateSystem !== "default") {
      ...
      if (imageCoordinateSystem === "cartesian" && defaultImageCoordinateSystem === "lnglat") {
        const bottomLeft = (0, import_web_mercator5.lngLatToWorld)([bounds[0], bounds[1]]);
        const topRight = (0, import_web_mercator5.lngLatToWorld)([bounds[2], bounds[3]]);
        return {
...
var IconManager = class {
  ...
  _loadIcons(icons) {
    ...
    for (const icon of icons) {
      this._pendingCount++;
      (0, import_core16.load)(icon.url, this._loadOptions).then((imageData) => {
        var _a;
        const id = getIconId(icon);
...
LineLayer.defaultProps = defaultProps5;
...
PointCloudLayer.defaultProps = defaultProps6;
...
var ColumnLayer = class extends Layer {
  ...
  _getModels() {
    ...
    const strokeModel = new import_engine11.Model(this.context.device, {
      ...shaders,
  ...
  _setFillGeometry(geometry) {
    const fillGeometry = (0, import_engine11.makeInterleavedGeometry)(geometry, {
  ...
  _setStrokeGeometry(geometry) {
    const strokeGeometry = (0, import_engine11.makeInterleavedGeometry)(geometry, {
      attributes: ["POSITION", "NORMAL"]
    });
  ...
  _setWireframeGeometry(geometry) {
    const wireframeGeometry = (0, import_engine11.makeInterleavedGeometry)(geometry, {
      attributes: ["POSITION", "NORMAL"]
    });
...
ColumnLayer.defaultProps = defaultProps8;
...
GridCellLayer.defaultProps = defaultProps9;
...
PathLayer.defaultProps = defaultProps10;
...
SolidPolygonLayer.defaultProps = defaultProps11;
...
PolygonLayer.defaultProps = defaultProps12;
...
TextBackgroundLayer.defaultProps = defaultProps14;
...
TextLayer.defaultProps = defaultProps15;
...
GeoJsonLayer.defaultProps = defaultProps16;
