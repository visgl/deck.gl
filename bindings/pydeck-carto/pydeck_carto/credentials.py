...
def load_carto_credentials(filepath=None, api_base_url=None, client_id=None,
                           client_secret=None):
    ...
    if filepath:
        ...
        content = dict(zip(['api_base_url', 'client_id', 'client_secret'],
    ...
    if response.status_code != 200:
        ...
        error_subjects = {403: 'Permissions Error',
                          401: 'Authorization Error',
                          }
        error_subject = error_subjects.get(response.status_code,
                                           'Credential Error')
        msg = f'{error_subject} - {error_msg.get("error")}: ' \
