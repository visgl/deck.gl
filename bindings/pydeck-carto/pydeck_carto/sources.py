...
class VectorTableSourceOptions(TableSourceOptions, ColumnOptions): pass
class VectorQuerySourceOptions(QuerySourceOptions, ColumnOptions): pass
class VectorTilesetSourceOptions(TilesetSourceOptions): pass

def vector_table_source(**kwargs: Unpack[VectorTableSourceOptions]):
    return pdk.types.Function("vectorTableSource", **{
        **column_options(**kwargs),
        **table_options(**kwargs)
    })

def vector_query_source(**kwargs: Unpack[VectorQuerySourceOptions]):
    return pdk.types.Function("vectorQuerySource", **{
        **column_options(**kwargs),
...
class H3TableSourceOptions(TableSourceOptions, AggregationOptions): pass
class H3QuerySourceOptions(QuerySourceOptions, AggregationOptions): pass
class H3TilesetSourceOptions(TilesetSourceOptions, AggregationOptions): pass

def h3_table_source(**kwargs: Unpack[H3TableSourceOptions]):
    return pdk.types.Function("h3TableSource", **{
        **aggregation_options(**kwargs),
        **table_options(**kwargs)
    })

def h3_query_source(**kwargs: Unpack[H3QuerySourceOptions]):
    return pdk.types.Function("h3QuerySource", **{
        **aggregation_options(**kwargs),
        **query_options(**kwargs)
    })

def h3_tileset_source(**kwargs: Unpack[H3TilesetSourceOptions]):
    return pdk.types.Function("h3TilesetSource", **{
        **aggregation_options(**kwargs),
...
class QuadbinTableSourceOptions(TableSourceOptions, AggregationOptions): pass
class QuadbinQuerySourceOptions(QuerySourceOptions, AggregationOptions): pass
class QuadbinTilesetSourceOptions(TilesetSourceOptions, AggregationOptions): pass

def quadbin_table_source(**kwargs: Unpack[QuadbinTableSourceOptions]):
    return pdk.types.Function("quadbinTableSource", **{
        **aggregation_options(**kwargs),
        **table_options(**kwargs)
    })

def quadbin_query_source(**kwargs: Unpack[QuadbinQuerySourceOptions]):
    return pdk.types.Function("quadbinQuerySource", **{
        **aggregation_options(**kwargs),
        **query_options(**kwargs)
    })

def quadbin_tileset_source(**kwargs: Unpack[QuadbinTilesetSourceOptions]):
    return pdk.types.Function("quadbinTilesetSource", **{
        **aggregation_options(**kwargs),
        **tileset_options(**kwargs)
    })
