...
In this case using a GeoSpatial Indexing System based on QuadBin and querying the carto information
"""
...
layer = pdk.Layer(
    "CartoLayer",
    data="select * from carto-demo-data.demo_tables.derived_spatialfeatures_usa_quadbin15_v1_yearly_v2 limit 1",
    type_=MapType.QUERY,
