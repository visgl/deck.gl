...
from traitlets import Any, Array, Bool, Int, Unicode

from ..data_utils.binary_transfer import array_seralization
...
class DeckGLWidget(widgets.DOMWidget):
    ...
    data = Array(default_value=None, allow_none=True).tag(sync=True, **array_seralization)
