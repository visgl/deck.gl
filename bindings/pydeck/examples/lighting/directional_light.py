...
light = pdk.Effect("DirectionalLight", color=[255, 235, 190], intensity=2.2, direction=[-2, -4, -3], _shadow=True)
...
deck.to_html("directional_light.html", css_background_color="#111827")
