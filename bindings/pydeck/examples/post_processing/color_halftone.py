...
Render the scene with a rotated CMYK dot pattern.
"""
...
effect = pdk.Effect("PostProcessEffect", module="colorHalftone", center=[0.5, 0.5], angle=0.7, size=8)
deck = pdk.Deck(
    layers=[scene_layer],
    effects=[effect],
...
deck.to_html("color_halftone.html", css_background_color="#090d18")
