...
effect = pdk.Effect("PostProcessEffect", module="bulgePinch", center=[0.5, 0.5], radius=250, strength=0.75)
deck = pdk.Deck(
    layers=[scene_layer],
    effects=[effect],
...
deck.to_html("bulge_pinch.html", css_background_color="#090d18")
