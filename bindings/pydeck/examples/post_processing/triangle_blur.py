...
Blur the image with a separable triangle filter.
"""
...
effect = pdk.Effect("PostProcessEffect", module="triangleBlur", radius=32)
deck = pdk.Deck(
    layers=[scene_layer],
    effects=[effect],
...
deck.to_html("triangle_blur.html", css_background_color="#090d18")
