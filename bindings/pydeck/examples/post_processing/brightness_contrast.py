...
Adjust brightness and contrast across the rendered scene.
"""
...
effect = pdk.Effect("PostProcessEffect", module="brightnessContrast", brightness=0.12, contrast=0.35)
deck = pdk.Deck(
    layers=[scene_layer],
    effects=[effect],
...
deck.to_html("brightness_contrast.html", css_background_color="#090d18")
