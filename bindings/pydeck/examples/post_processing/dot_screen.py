...
Render the scene as a monochrome halftone pattern.
"""
...
effect = pdk.Effect("PostProcessEffect", module="dotScreen", center=[0.5, 0.5], angle=1.0, size=7)
deck = pdk.Deck(
    layers=[scene_layer],
    effects=[effect],
...
deck.to_html("dot_screen.html", css_background_color="#090d18")
