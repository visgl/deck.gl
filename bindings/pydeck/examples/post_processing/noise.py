...
Add monochrome noise to the rendered image.
"""
...
effect = pdk.Effect("PostProcessEffect", module="noise", amount=0.65)
deck = pdk.Deck(
    layers=[scene_layer],
    effects=[effect],
...
deck.to_html("noise.html", css_background_color="#090d18")
