...
Apply fast approximate anti-aliasing to rendered edges.
"""
...
effect = pdk.Effect("PostProcessEffect", module="fxaa")
deck = pdk.Deck(
    layers=[scene_layer],
    effects=[effect],
...
deck.to_html("fxaa.html", css_background_color="#090d18")
