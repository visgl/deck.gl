...
Rotate hue and increase color saturation.
"""
...
effect = pdk.Effect("PostProcessEffect", module="hueSaturation", hue=0.45, saturation=0.65)
deck = pdk.Deck(
    layers=[scene_layer],
    effects=[effect],
...
deck.to_html("hue_saturation.html", css_background_color="#090d18")
