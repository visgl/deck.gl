...
Apply a warm photographic sepia treatment.
"""
...
effect = pdk.Effect("PostProcessEffect", module="sepia", amount=1.0)
deck = pdk.Deck(
    layers=[scene_layer],
    effects=[effect],
...
deck.to_html("sepia.html", css_background_color="#090d18")
