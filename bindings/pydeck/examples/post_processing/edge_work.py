...
Extract prominent image frequencies into graphic edges.
"""
...
effect = pdk.Effect("PostProcessEffect", module="edgeWork", radius=6)
deck = pdk.Deck(
    layers=[scene_layer],
    effects=[effect],
...
deck.to_html("edge_work.html", css_background_color="#090d18")
