...
Sample the scene into a field of hexagonal tiles.
"""
...
effect = pdk.Effect("PostProcessEffect", module="hexagonalPixelate", center=[0.5, 0.5], scale=18)
deck = pdk.Deck(
    layers=[scene_layer],
    effects=[effect],
...
deck.to_html("hexagonal_pixelate.html", css_background_color="#090d18")
