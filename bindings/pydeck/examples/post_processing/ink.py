...
Darken detected edges to simulate an ink drawing.
"""
...
effect = pdk.Effect("PostProcessEffect", module="ink", strength=0.8)
deck = pdk.Deck(
    layers=[scene_layer],
    effects=[effect],
...
deck.to_html("ink.html", css_background_color="#090d18")
