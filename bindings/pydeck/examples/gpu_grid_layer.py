...
layer = pdk.Layer(
    "GPUGridLayer", df, pickable=True, extruded=True, cellSize=200, elevation_scale=4, get_position="COORDINATES",
)
...
r.to_html("gpu_grid_layer.html", notebook_display=False)
