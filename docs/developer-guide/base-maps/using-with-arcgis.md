...
| ----- | ----- | ----- | ----- |
| ✓ | ✓ | | [example](https://github.com/visgl/deck.gl/tree/9.4-release/examples/get-started/pure-js/arcgis) |
...
2D integration with `MapView` is supported by the [DeckLayer](../../api-reference/arcgis/deck-layer.md) class, see [pure JS example](https://github.com/visgl/deck.gl/tree/9.4-release/examples/get-started/pure-js/arcgis).
