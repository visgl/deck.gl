...
deck.gl provides an extensive [layer catalog](/docs/developer-guide/using-layers.md) and is designed to compose many layers together to form complex visuals.
