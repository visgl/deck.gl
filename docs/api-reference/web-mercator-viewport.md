...
[modules/core/src/viewports/web-mercator-viewport.js](https://github.com/uber/deck.gl/blob/5.3-release/modules/core/src/viewports/web-mercator-viewport.js)
