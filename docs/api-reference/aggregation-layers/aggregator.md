...
[modules/aggregation-layers/src/common/aggregator/aggregator.ts](https://github.com/visgl/deck.gl/tree/9.4-release/modules/aggregation-layers/src/common/aggregator/aggregator.ts)
