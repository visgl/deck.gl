...
[modules/aggregation-layers/src/common/aggregation-layer.ts](https://github.com/visgl/deck.gl/tree/9.4-release/modules/aggregation-layers/src/common/aggregation-layer.ts)
