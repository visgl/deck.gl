...
[modules/core/src/controllers/first-person-controller.js](https://github.com/visgl/deck.gl/tree/8.6-release/modules/core/src/controllers/first-person-controller.js)
