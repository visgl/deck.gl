...
[modules/core/src/transitions/linear-interpolator.ts](https://github.com/visgl/deck.gl/tree/9.4-release/modules/core/src/transitions/linear-interpolator.ts)
