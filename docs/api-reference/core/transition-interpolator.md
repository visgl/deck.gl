...
[modules/core/src/transitions/transition-interpolator.js](https://github.com/visgl/deck.gl/tree/8.3-release/modules/core/src/transitions/transition-interpolator.js)
