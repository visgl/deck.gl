...
[modules/core/src/transitions/viewport-fly-to-interpolator.js](https://github.com/visgl/deck.gl/tree/8.6-release/modules/core/src/transitions/viewport-fly-to-interpolator.js)
