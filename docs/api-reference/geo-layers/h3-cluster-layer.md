...
[modules/geo-layers/src/h3-layers/h3-cluster-layer](https://github.com/visgl/deck.gl/tree/8.7-release/modules/geo-layers/src/h3-layers/h3-cluster-layer.js)
