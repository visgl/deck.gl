...
[modules/geo-layers/src/h3-layers/h3-hexagon-layer.ts](https://github.com/visgl/deck.gl/tree/9.4-release/modules/geo-layers/src/h3-layers/h3-hexagon-layer.ts)
