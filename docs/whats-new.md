...
- [`BrushingExtension`](./api-reference/extensions/brushing-extension.md#brushingradius) measures `brushingRadius` in meters on `MapView` at every zoom level; below zoom 12 it was previously shrunk by cos(latitude).
