...
or a URL to a mesh description file in a format supported by [loaders.gl](https://https://github.com/visgl/loaders.gl) (the appropriate loader will have to be registered via the loaders.gl
