...
Our [examples](https://github.com/uber/deck.gl/tree/6.3-release/examples/get-started) contains a few "pure JS" templates that serve as a starting point for your application.
