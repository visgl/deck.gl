...
deck.gl is designed to simplify high-performance, WebGL-based visualization of large data sets, both geospatial and non-geospatial. Users can quickly get impressive visual results with minimal effort by composing existing layers, or leverage deck.gl's extensible architecture to address custom needs.
...
* For geospatial data sets, cartographic projections and integration with major basemap providers including Mapbox, Google Maps and ESRI.
