...
const SIZE_ES5_CONFIG = Object.assign({}, TEST_BROWSER_CONFIG, {
  resolve: {
    mainFields: ['esnext', 'browser', 'module', 'main'],
    alias: Object.assign({}, ALIASES, {
      'deck.gl': resolve(__dirname, '../dist')
    })
  }
});
...
function getBundleConfig(env) {
  ...
  const config = Object.assign({}, env.es5 ? SIZE_ES5_CONFIG : SIZE_ESM_CONFIG, {
