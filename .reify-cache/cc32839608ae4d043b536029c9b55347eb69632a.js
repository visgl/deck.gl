"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var createProps;module.link('@deck.gl/core/lifecycle/create-props',{createProps(v){createProps=v}},1);var compareProps;module.link('@deck.gl/core/lifecycle/props',{compareProps(v){compareProps=v}},2);var Vector2;module.link('math.gl',{Vector2(v){Vector2=v}},3);
