"use strict";module.export({default:()=>extractJSXLayers});var React,createElement;module.link('react',{default(v){React=v},createElement(v){createElement=v}},0);var inheritsFrom;module.link('./inherits-from',{inheritsFrom(v){inheritsFrom=v}},1);var Layer,View;module.link('@deck.gl/core',{Layer(v){Layer=v},View(v){View=v}},2);
