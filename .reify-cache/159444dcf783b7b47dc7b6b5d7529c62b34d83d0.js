"use strict";module.export({default:()=>TileLayer});var CompositeLayer;module.link('@deck.gl/core',{CompositeLayer(v){CompositeLayer=v}},0);var GeoJsonLayer;module.link('@deck.gl/layers',{GeoJsonLayer(v){GeoJsonLayer=v}},1);var TileCache;module.link('./utils/tile-cache',{default(v){TileCache=v}},2);
