"use strict";module.export({default:()=>FontAtlasManager});module.export({DEFAULT_CHAR_SET:()=>DEFAULT_CHAR_SET,DEFAULT_FONT_FAMILY:()=>DEFAULT_FONT_FAMILY,DEFAULT_FONT_WEIGHT:()=>DEFAULT_FONT_WEIGHT,DEFAULT_FONT_SIZE:()=>DEFAULT_FONT_SIZE,DEFAULT_BUFFER:()=>DEFAULT_BUFFER,DEFAULT_CUTOFF:()=>DEFAULT_CUTOFF,DEFAULT_RADIUS:()=>DEFAULT_RADIUS},true);var Texture2D;module.link('@luma.gl/core',{Texture2D(v){Texture2D=v}},0);var TinySDF;module.link('@mapbox/tiny-sdf',{default(v){TinySDF=v}},1);var GL;module.link('@luma.gl/constants',{default(v){GL=v}},2);var buildMapping;module.link('./font-atlas-utils',{buildMapping(v){buildMapping=v}},3);var LRUCache;module.link('./lru-cache',{default(v){LRUCache=v}},4);/* global document */
