"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var TransitionManager;module.link('@deck.gl/core/controllers/transition-manager',{default(v){TransitionManager=v}},1);var testExports;module.link('@deck.gl/core/controllers/map-controller',{testExports(v){testExports=v}},2);
