"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var Viewport;module.link('deck.gl',{Viewport(v){Viewport=v}},1);var mat4;module.link('gl-matrix/mat4',{"*"(v){mat4=v}},2);
