"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var shallowEqualObjects;module.link('@deck.gl/json/utils/shallow-equal-objects',{shallowEqualObjects(v){shallowEqualObjects=v}},1);
