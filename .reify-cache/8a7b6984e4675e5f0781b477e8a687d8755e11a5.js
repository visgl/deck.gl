"use strict";module.export({default:()=>JSONConverter});var shallowEqualObjects;module.link('../utils/shallow-equal-objects.js',{shallowEqualObjects(v){shallowEqualObjects=v}},0);var parseJSON;module.link('../parsers/parse-json',{default(v){parseJSON=v}},1);var convertTopLevelJSON;module.link('../parsers/convert-json',{convertTopLevelJSON(v){convertTopLevelJSON=v}},2);// Converts JSON to props ("hydrating" classes, resolving enums and functions etc).
