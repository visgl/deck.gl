"use strict";module.export({default:()=>AttributeTransitionManager});var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);var Buffer,Transform;module.link('luma.gl',{Buffer(v){Buffer=v},Transform(v){Transform=v}},1);var getShaders,getBuffers,padBuffer;module.link('./attribute-transition-utils',{getShaders(v){getShaders=v},getBuffers(v){getBuffers=v},padBuffer(v){padBuffer=v}},2);var Attribute;module.link('./attribute',{default(v){Attribute=v}},3);var Transition;module.link('../transitions/transition',{default(v){Transition=v}},4);var log;module.link('../utils/log',{default(v){log=v}},5);var assert;module.link('../utils/assert',{default(v){assert=v}},6);
