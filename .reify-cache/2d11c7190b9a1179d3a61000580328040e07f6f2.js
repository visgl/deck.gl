"use strict";module.export({default:()=>TileCache});var Tile;module.link('./tile',{default(v){Tile=v}},0);var getTileIndices;module.link('./viewport-util',{getTileIndices(v){getTileIndices=v}},1);
