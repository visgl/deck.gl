"use strict";module.export({default:()=>OrthographicView});var View;module.link('./view',{default(v){View=v}},0);var Viewport;module.link('../viewports/viewport',{default(v){Viewport=v}},1);var Matrix4;module.link('math.gl',{Matrix4(v){Matrix4=v}},2);var OrthographicController;module.link('../controllers/orthographic-controller',{default(v){OrthographicController=v}},3);
