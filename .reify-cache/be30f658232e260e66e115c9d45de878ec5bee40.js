"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var quantizeScale;module.link('@deck.gl/aggregation-layers/utils/scale-utils',{quantizeScale(v){quantizeScale=v}},1);
