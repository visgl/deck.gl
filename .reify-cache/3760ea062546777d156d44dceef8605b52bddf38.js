"use strict";module.export({getMatrixAttributes:()=>getMatrixAttributes});var createIterable;module.link('@deck.gl/core',{createIterable(v){createIterable=v}},0);
...
function getMatrixAttributes(layer) {
  return {
    size: 12,
