"use strict";module.export({GridAggregationData:()=>GridAggregationData},true);var WebMercatorViewport;module.link('deck.gl',{WebMercatorViewport(v){WebMercatorViewport=v}},0);var dataSamples;module.link('../../examples/layer-browser/src/data-samples',{"*"(v){dataSamples=v}},1);var fp64;module.link('luma.gl',{fp64(v){fp64=v}},2);
