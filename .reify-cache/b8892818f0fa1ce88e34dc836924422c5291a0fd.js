"use strict";module.export({default:()=>View});var Viewport;module.link('../viewports/viewport',{default(v){Viewport=v}},0);var parsePosition,getPosition;module.link('../utils/positions',{parsePosition(v){parsePosition=v},getPosition(v){getPosition=v}},1);var deepEqual;module.link('../utils/deep-equal',{deepEqual(v){deepEqual=v}},2);var assert;module.link('../utils/assert',{default(v){assert=v}},3);
