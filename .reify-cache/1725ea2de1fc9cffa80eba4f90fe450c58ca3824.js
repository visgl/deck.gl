"use strict";module.export({getDeckInstance:()=>getDeckInstance,addLayer:()=>addLayer,removeLayer:()=>removeLayer,updateLayer:()=>updateLayer,drawLayer:()=>drawLayer,getViewState:()=>getViewState});var Deck;module.link('@deck.gl/core',{Deck(v){Deck=v}},0);var withParameters;module.link('@luma.gl/core',{withParameters(v){withParameters=v}},1);
