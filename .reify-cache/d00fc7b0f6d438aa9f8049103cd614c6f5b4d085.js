"use strict";module.export({default:()=>MapController});module.export({MAPBOX_LIMITS:()=>MAPBOX_LIMITS,testExports:()=>testExports},true);var clamp;module.link('math.gl',{clamp(v){clamp=v}},0);var Controller;module.link('./controller',{default(v){Controller=v}},1);var ViewState;module.link('./view-state',{default(v){ViewState=v}},2);var WebMercatorViewport,normalizeViewportProps;module.link('viewport-mercator-project',{default(v){WebMercatorViewport=v},normalizeViewportProps(v){normalizeViewportProps=v}},3);var assert;module.link('../utils/assert',{default(v){assert=v}},4);var LinearInterpolator;module.link('../transitions/linear-interpolator',{default(v){LinearInterpolator=v}},5);var TRANSITION_EVENTS;module.link('./transition-manager',{TRANSITION_EVENTS(v){TRANSITION_EVENTS=v}},6);
