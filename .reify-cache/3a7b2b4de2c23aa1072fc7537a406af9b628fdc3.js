"use strict";module.export({default:()=>FirstPersonController});var Controller;module.link('./controller',{default(v){Controller=v}},0);var ViewState;module.link('./view-state',{default(v){ViewState=v}},1);var Vector3,clamp;module.link('math.gl',{Vector3(v){Vector3=v},clamp(v){clamp=v}},2);
