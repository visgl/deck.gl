"use strict";module.export({default:()=>TransitionInterpolator});var equals;module.link('math.gl',{equals(v){equals=v}},0);var assert;module.link('../utils/assert',{default(v){assert=v}},1);
