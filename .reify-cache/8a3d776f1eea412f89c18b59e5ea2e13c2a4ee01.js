"use strict";module.export({default:()=>Component});var LIFECYCLE;module.link('../lifecycle/constants',{LIFECYCLE(v){LIFECYCLE=v}},0);var createProps;module.link('../lifecycle/create-props',{createProps(v){createProps=v}},1);var ComponentState;module.link('./component-state',{default(v){ComponentState=v}},2);
