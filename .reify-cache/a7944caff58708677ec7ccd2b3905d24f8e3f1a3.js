"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var Transition,TRANSITION_STATE;module.link('@deck.gl/core/transitions/transition',{default(v){Transition=v},TRANSITION_STATE(v){TRANSITION_STATE=v}},1);
