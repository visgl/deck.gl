"use strict";module.export({default:()=>TransitionManager});module.export({TRANSITION_EVENTS:()=>TRANSITION_EVENTS},true);var LinearInterpolator;module.link('../transitions/linear-interpolator',{default(v){LinearInterpolator=v}},0);var Transition;module.link('../transitions/transition',{default(v){Transition=v}},1);var assert;module.link('../utils/assert',{default(v){assert=v}},2);/* global requestAnimationFrame, cancelAnimationFrame */
