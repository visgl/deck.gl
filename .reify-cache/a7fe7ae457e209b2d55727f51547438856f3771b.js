"use strict";module.export({default:()=>LightingEffect});var AmbientLight,PointLight,DirectionalLight;module.link('@luma.gl/core',{AmbientLight(v){AmbientLight=v},PointLight(v){PointLight=v},DirectionalLight(v){DirectionalLight=v}},0);var Effect;module.link('../lib/effect',{default(v){Effect=v}},1);var projectPosition;module.link('../shaderlib/project/project-functions',{projectPosition(v){projectPosition=v}},2);var COORDINATE_SYSTEM;module.link('../lib',{COORDINATE_SYSTEM(v){COORDINATE_SYSTEM=v}},3);
