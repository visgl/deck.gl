"use strict";module.export({ISOLINES_CODE_OFFSET_MAP:()=>ISOLINES_CODE_OFFSET_MAP,ISOBANDS_CODE_OFFSET_MAP:()=>ISOBANDS_CODE_OFFSET_MAP},true);// Code to Offsets Map needed to implement Marching Squres algorithm
