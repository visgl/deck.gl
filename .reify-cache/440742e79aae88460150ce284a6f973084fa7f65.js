"use strict";module.export({default:()=>LayerAttribute,glArrayFromType:()=>glArrayFromType});var assert;module.link('../utils/assert',{default(v){assert=v}},0);var GL;module.link('@luma.gl/constants',{default(v){GL=v}},1);var Buffer,Attribute;module.link('luma.gl',{Buffer(v){Buffer=v},_Attribute(v){Attribute=v}},2);var createIterable;module.link('../utils/iterable-utils',{createIterable(v){createIterable=v}},3);var log;module.link('../utils/log',{default(v){log=v}},4);/* eslint-disable complexity */
