"use strict";module.export({createProps:()=>createProps});var applyPropOverrides;module.link('../lib/seer-integration',{applyPropOverrides(v){applyPropOverrides=v}},0);var log;module.link('../utils/log',{default(v){log=v}},1);var parsePropTypes;module.link('./prop-types',{parsePropTypes(v){parsePropTypes=v}},2);
