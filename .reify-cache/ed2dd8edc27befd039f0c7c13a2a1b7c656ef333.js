"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var ViewManager;module.link('@deck.gl/core/lib/view-manager',{default(v){ViewManager=v}},1);var MapView,Viewport;module.link('deck.gl',{MapView(v){MapView=v},Viewport(v){Viewport=v}},2);
