"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var FlyToInterpolator;module.link('@deck.gl/core/transitions/viewport-fly-to-interpolator',{default(v){FlyToInterpolator=v}},1);var toLowPrecision;module.link('@deck.gl/test-utils',{toLowPrecision(v){toLowPrecision=v}},2);
