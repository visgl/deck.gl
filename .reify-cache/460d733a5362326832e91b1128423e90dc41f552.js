"use strict";module.export({default:()=>H3ClusterLayer});var h3SetToMultiPolygon;module.link('h3-js',{h3SetToMultiPolygon(v){h3SetToMultiPolygon=v}},0);var CompositeLayer,createIterable;module.link('@deck.gl/core',{CompositeLayer(v){CompositeLayer=v},createIterable(v){createIterable=v}},1);var PolygonLayer;module.link('@deck.gl/layers',{PolygonLayer(v){PolygonLayer=v}},2);
