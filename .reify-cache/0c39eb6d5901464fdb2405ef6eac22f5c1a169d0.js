"use strict";module.export({pointToDensityGridData:()=>pointToDensityGridData,alignToCell:()=>alignToCell});var Matrix4;module.link('math.gl',{Matrix4(v){Matrix4=v}},0);var fp64Utils;module.link('@luma.gl/core',{fp64(v){fp64Utils=v}},1);var COORDINATE_SYSTEM,log,createIterable,experimental;module.link('@deck.gl/core',{COORDINATE_SYSTEM(v){COORDINATE_SYSTEM=v},log(v){log=v},createIterable(v){createIterable=v},experimental(v){experimental=v}},2);var AGGREGATION_OPERATION;module.link('./gpu-grid-aggregator-constants',{AGGREGATION_OPERATION(v){AGGREGATION_OPERATION=v}},3);
