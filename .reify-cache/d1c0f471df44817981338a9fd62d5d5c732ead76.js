"use strict";var AttributeTransitionManager;module.link('@deck.gl/core/lib/attribute-transition-manager',{default(v){AttributeTransitionManager=v}},0);var Attribute;module.link('@deck.gl/core/lib/attribute',{default(v){Attribute=v}},1);var test;module.link('tape-catch',{default(v){test=v}},2);var isWebGL2;module.link('luma.gl',{isWebGL2(v){isWebGL2=v}},3);var gl;module.link('@deck.gl/test-utils',{gl(v){gl=v}},4);/* eslint-disable max-statements */
