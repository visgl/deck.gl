"use strict";module.export({getWorldPosition:()=>getWorldPosition,projectPosition:()=>projectPosition});var COORDINATE_SYSTEM;module.link('../../lib/constants',{COORDINATE_SYSTEM(v){COORDINATE_SYSTEM=v}},0);var LNGLAT_AUTO_OFFSET_ZOOM_THRESHOLD;module.link('./viewport-uniforms',{LNGLAT_AUTO_OFFSET_ZOOM_THRESHOLD(v){LNGLAT_AUTO_OFFSET_ZOOM_THRESHOLD=v}},1);var vec4;module.link('gl-matrix/vec4',{"*"(v){vec4=v}},2);var vec3;module.link('gl-matrix/vec3',{"*"(v){vec3=v}},3);var getDistanceScales,addMetersToLngLat;module.link('viewport-mercator-project',{getDistanceScales(v){getDistanceScales=v},addMetersToLngLat(v){addMetersToLngLat=v}},4);/**
 * Projection utils
