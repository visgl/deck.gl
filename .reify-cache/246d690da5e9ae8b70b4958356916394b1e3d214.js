"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var LinearInterpolator;module.link('@deck.gl/core/transitions/linear-interpolator',{default(v){LinearInterpolator=v}},1);
