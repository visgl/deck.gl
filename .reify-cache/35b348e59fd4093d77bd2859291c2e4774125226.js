"use strict";var test;module.link('tape',{default(v){test=v}},0);var buildMapping,getDiffIcons;module.link('@deck.gl/layers/icon-layer/icon-manager',{buildMapping(v){buildMapping=v},getDiffIcons(v){getDiffIcons=v}},1);
