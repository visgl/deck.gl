"use strict";module.export({convertTopLevelJSON:()=>convertTopLevelJSON,getJSONLayers:()=>getJSONLayers});var MapView,FirstPersonView,OrbitView,OrthographicView;module.link('@deck.gl/core',{MapView(v){MapView=v},FirstPersonView(v){FirstPersonView=v},OrbitView(v){OrbitView=v},OrthographicView(v){OrthographicView=v}},0);var JSONLayer;module.link('../json-layer/json-layer',{default(v){JSONLayer=v}},1);var get;module.link('../utils/get',{get(v){get=v}},2);var csvParseRows;module.link('d3-dsv',{csvParseRows(v){csvParseRows=v}},3);// Converts a JSON payload to a deck.gl props object
