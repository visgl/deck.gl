"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var parsePropTypes;module.link('@deck.gl/core/lifecycle/prop-types',{parsePropTypes(v){parsePropTypes=v}},1);
