"use strict";module.export({default:()=>DeckRenderer});var log;module.link('../utils/log',{default(v){log=v}},0);var DrawLayersPass;module.link('../passes/draw-layers-pass',{default(v){DrawLayersPass=v}},1);var PickLayersPass;module.link('../passes/pick-layers-pass',{default(v){PickLayersPass=v}},2);var getPixelRatio;module.link('../utils/get-pixel-ratio',{default(v){getPixelRatio=v}},3);
