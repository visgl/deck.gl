"use strict";module.export({default:()=>OrbitController});var clamp;module.link('math.gl',{clamp(v){clamp=v}},0);var Controller;module.link('./controller',{default(v){Controller=v}},1);var OrbitViewport;module.link('../deprecated/orbit-viewport',{default(v){OrbitViewport=v}},2);var assert;module.link('../utils/assert',{default(v){assert=v}},3);var LinearInterpolator;module.link('../transitions/linear-interpolator',{default(v){LinearInterpolator=v}},4);var TRANSITION_EVENTS;module.link('./transition-manager',{TRANSITION_EVENTS(v){TRANSITION_EVENTS=v}},5);
