"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var getCode,getVertices,CONTOUR_TYPE;module.link('@deck.gl/aggregation-layers/contour-layer/marching-squares',{getCode(v){getCode=v},getVertices(v){getVertices=v},CONTOUR_TYPE(v){CONTOUR_TYPE=v}},1);
