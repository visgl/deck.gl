"use strict";module.export({getCode:()=>getCode,getVertices:()=>getVertices});module.export({CONTOUR_TYPE:()=>CONTOUR_TYPE},true);var log;module.link('@deck.gl/core',{log(v){log=v}},0);var ISOLINES_CODE_OFFSET_MAP,ISOBANDS_CODE_OFFSET_MAP;module.link('./marching-squares-codes',{ISOLINES_CODE_OFFSET_MAP(v){ISOLINES_CODE_OFFSET_MAP=v},ISOBANDS_CODE_OFFSET_MAP(v){ISOBANDS_CODE_OFFSET_MAP=v}},1);// All utility mehtods needed to implement Marching Squres algorithm
