"use strict";module.export({default:()=>OrbitView});var View;module.link('./view',{default(v){View=v}},0);var Viewport;module.link('../viewports/viewport',{default(v){Viewport=v}},1);var createMat4,transformVector;module.link('../utils/math-utils',{createMat4(v){createMat4=v},transformVector(v){transformVector=v}},2);var mat4;module.link('gl-matrix/mat4',{"*"(v){mat4=v}},3);var OrbitController;module.link('../controllers/orbit-controller',{default(v){OrbitController=v}},4);
