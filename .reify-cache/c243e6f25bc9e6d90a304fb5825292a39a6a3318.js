"use strict";module.export({generateContours:()=>generateContours});var getCode,getVertices,CONTOUR_TYPE;module.link('./marching-squares',{getCode(v){getCode=v},getVertices(v){getVertices=v},CONTOUR_TYPE(v){CONTOUR_TYPE=v}},0);
