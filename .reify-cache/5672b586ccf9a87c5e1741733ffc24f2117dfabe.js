"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var memoize;module.link('@deck.gl/core/utils/memoize',{default(v){memoize=v}},1);var makeSpy;module.link('@probe.gl/test-utils',{makeSpy(v){makeSpy=v}},2);
