"use strict";module.export({default:()=>OrthographicController});var Controller;module.link('./controller',{default(v){Controller=v}},0);var ViewState;module.link('./view-state',{default(v){ViewState=v}},1);var Vector2,clamp;module.link('math.gl',{Vector2(v){Vector2=v},clamp(v){clamp=v}},2);
