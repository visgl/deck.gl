"use strict";module.export({validateProps:()=>validateProps,diffProps:()=>diffProps,compareProps:()=>compareProps});var assert;module.link('../utils/assert',{default(v){assert=v}},0);
