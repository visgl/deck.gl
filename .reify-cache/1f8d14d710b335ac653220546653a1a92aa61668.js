"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var TransitionInterpolator;module.link('@deck.gl/core/transitions/transition-interpolator',{default(v){TransitionInterpolator=v}},1);
