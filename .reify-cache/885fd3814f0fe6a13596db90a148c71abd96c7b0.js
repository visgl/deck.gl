"use strict";module.export({default:()=>LayersPass});var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);var Pass;module.link('./pass',{default(v){Pass=v}},1);var clear,setParameters,withParameters;module.link('luma.gl',{clear(v){clear=v},setParameters(v){setParameters=v},withParameters(v){withParameters=v}},2);
