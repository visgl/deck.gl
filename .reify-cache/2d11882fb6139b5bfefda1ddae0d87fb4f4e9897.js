"use strict";module.export({setPropOverrides:()=>setPropOverrides,applyPropOverrides:()=>applyPropOverrides,layerEditListener:()=>layerEditListener,seerInitListener:()=>seerInitListener,initLayerInSeer:()=>initLayerInSeer,updateLayerInSeer:()=>updateLayerInSeer,removeLayerInSeer:()=>removeLayerInSeer},true);var seer;module.link('seer',{default(v){seer=v}},0);
