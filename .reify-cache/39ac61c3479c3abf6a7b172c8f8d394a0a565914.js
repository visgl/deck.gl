"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var parsePosition,getPosition;module.link('@deck.gl/core/utils/positions',{parsePosition(v){parsePosition=v},getPosition(v){getPosition=v}},1);
