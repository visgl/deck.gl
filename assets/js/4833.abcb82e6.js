...
${(_=(g=l).stride/g.ValueType.BYTES_PER_ELEMENT,b=g.offset/g.ValueType.BYTES_PER_ELEMENT,y=(0,a.iP)(g.type),`fn write_result(rowIndex: u32, value: array<${y}, ${g.size}>) {
...
void main() {
  ${r} = ${a};
}`}},8780(e,t,i){i.d(t,{U0:()=>et,_P:()=>ee,Ry:()=>ei});var r=i(72560),n=i(65261),s=i(31770);let a=[[/^(#version[ \t]+(100|300[ \t]+es))?[ \t]*\n/,"#version 300 es\n"],[/\btexture(2D|2DProj|Cube)Lod(EXT)?\(/g,"textureLod("],[/\btexture(2D|2DProj|Cube)(EXT)?\(/g,"texture("]],o=[...a,[f("attribute"),"in $1"],[f("varying"),"out $1"]],u=[...a,[f("varying"),"in $1"]];function l(e,t){for(let[i,r]of t)e=e.replace(i,r);return e}function f(e){return RegExp(`\\b${e}[ \\t]+(\\w+[ \\t]+\\w+(\\[\\w+\\])?;)`,"g")}var h=i(19237);function c(e,t,i="glsl"){let r="";for(let n in e){let s=e[n],a="wgsl"===i?"fn":"void";if(r+=`${a} ${s.signature} {
`,s.header&&(r+=`  ${s.header}`),t[n]){let e=t[n];for(let t of(e.sort((e,t)=>e.order-t.order),e))r+=`  ${t.injection}
`}s.footer&&(r+=`  ${s.footer}`),r+="}\n"}return r}function d(e){let t={vertex:{},fragment:{}};for(let i of e){let e,r;"string"!=typeof i?r=(e=i).hook:(e={},r=i);let n=(r=r.trim()).indexOf(":"),s=r.slice(0,n),a=r.slice(n+1),o=r.replace(/\(.+/,""),u=Object.assign(e,{signature:a});switch(s){case"vs":t.vertex[o]=u;break;case"fs":t.fragment[o]=u;break;default:throw Error(s)}}return t}var p=i(67926),g=i(68062);let m=[RegExp(`@binding\\(\\s*(\\d+)\\s*\\)\\s*@group\\(\\s*(\\d+)\\s*\\)\\s*${g.Qw}\\s*:\\s*([^;]+);`,"g"),RegExp(`@group\\(\\s*(\\d+)\\s*\\)\\s*@binding\\(\\s*(\\d+)\\s*\\)\\s*${g.Qw}\\s*:\\s*([^;]+);`,"g")];function _(e,t=[]){let i=(0,g.mh)(e),r=new Map;for(let e of t)r.set(b(e.name,e.group,e.location),e.moduleName);let n=[];for(let e of m){let t;for(e.lastIndex=0,t=e.exec(i);t;){let s=e===m[0],a=Number(t[s?1:2]),o=Number(t[s?2:1]),u=t[3]?.trim(),l=t[4],f=t[5].trim(),h=r.get(b(l,o,a));n.push(function(e){var t;let i={name:e.name,group:e.group,binding:e.binding,owner:e.owner,kind:"unknown",moduleName:e.moduleName,resourceType:e.resourceType};if(e.accessDeclaration){let t=e.accessDeclaration.split(",").map(e=>e.trim());if("uniform"===t[0])return{...i,kind:"uniform",access:"uniform"};if("storage"===t[0]){let e=t[1]||"read_write";return{...i,kind:"read"===e?"read-only-storage":"storage",access:e}}}return"sampler"===e.resourceType||"sampler_comparison"===e.resourceType?{...i,kind:"sampler",samplerKind:"sampler_comparison"===e.resourceType?"comparison":"filtering"}:e.resourceType.startsWith("texture_storage_")?{...i,kind:"storage-texture",access:function(e){let t=/,\s*([A-Za-z_][A-Za-z0-9_]*)\s*>$/.exec(e);return t?.[1]}(e.resourceType),viewDimension:y(e.resourceType)}:e.resourceType.startsWith("texture_")?{...i,kind:"texture",viewDimension:y(e.resourceType),sampleType:(t=e.resourceType).startsWith("texture_depth_")?"depth":t.includes("<i32>")?"sint":t.includes("<u32>")?"uint":t.includes("<f32>")?"float":void 0,multisampled:e.resourceType.startsWith("texture_multisampled_")}:i}({name:l,group:o,binding:a,owner:h?"module":"application",moduleName:h,accessDeclaration:u,resourceType:f})),t=e.exec(i)}}return n.sort((e,t)=>e.group!==t.group?e.group-t.group:e.binding!==t.binding?e.binding-t.binding:e.name.localeCompare(t.name))}function b(e,t,i){return`${t}:${i}:${e}`}function y(e){return e.includes("cube_array")?"cube-array":e.includes("2d_array")?"2d-array":e.includes("cube")?"cube":e.includes("3d")?"3d":e.includes("2d")?"2d":e.includes("1d")?"1d":void 0}var v=i(3180);let w="([a-zA-Z_][a-zA-Z0-9_]*)",E=/^\s*\#\s*if\s+(.+?)\s*(?:\/\/.*)?$/,x=RegExp(`^\\s*\\#\\s*ifdef\\s*${w}\\s*$`),S=RegExp(`^\\s*\\#\\s*ifndef\\s*${w}\\s*(?:\\/\\/.*)?$`),A=/^\s*\#\s*else\s*(?:\/\/.*)?$/,L=/^\s*\#\s*endif\s*$/,B=RegExp(`^\\s*\\#\\s*ifdef\\s*${w}\\s*(?:\\/\\/.*)?$`),T=/^\s*\#\s*endif\s*(?:\/\/.*)?$/;function P(e,t){let i=e.split("\n"),r=[],n=[],s=!0;for(let e of i){let i=e.match(E),a=e.match(B)||e.match(x),o=e.match(S),u=e.match(A),l=e.match(T)||e.match(L);if(i){let e=function(e,t){let i=e.trim();if(/^[+-]?\d+(?:\.\d+)?$/.test(i))return 0!==Number(i);if("true"===i)return!0;if("false"===i)return!1;let r=i.match(RegExp(`^!\\s*${w}$`));if(r)return!t[r[1]];let n=i.match(RegExp(`^${w}$`));if(n)return!!t[n[1]];let s=i.match(RegExp(`^defined\\s*\\(\\s*${w}\\s*\\)$`));if(s)return void 0!==t[s[1]];let a=i.match(RegExp(`^!\\s*defined\\s*\\(\\s*${w}\\s*\\)$`));if(a)return void 0===t[a[1]];throw Error(`Unsupported #if expression "${e}"`)}(i[1],t?.defines||{}),r=s&&e;n.push({parentActive:s,branchTaken:e,active:r}),s=r}else if(a||o){let e=(a||o)?.[1],i=!!t?.defines?.[e],r=a?i:!i,u=s&&r;n.push({parentActive:s,branchTaken:r,active:u}),s=u}else if(u){let e=n[n.length-1];if(!e)throw Error("Encountered #else without matching #if, #ifdef or #ifndef");e.active=e.parentActive&&!e.branchTaken,e.branchTaken=!0,s=e.active}else l?(n.pop(),s=!n.length||n[n.length-1].active):s&&r.push(e)}if(n.length>0)throw Error("Unterminated conditional block in shader source");return r.join("\n")}var M=i(44791);function $(e){let{primitiveType:t,components:i}=M.Co.getAttributeShaderTypeInfo(e),r="i32"===t?"int":"u32"===t?"uint":"float";return 1===i?r:`${"int"===r?"i":"uint"===r?"u":""}vec${i}`}function O(e){let t=[],i=/@location\s*\(\s*(\d+)\s*\)/g,r=i.exec(e);for(;r;)t.push(Number(r[1])),r=i.exec(e);return t}function C(e){let t=[],i=/(?:^|,)\s*(?:@[A-Za-z_][\w]*(?:\([^)]*\))?\s*)*([A-Za-z_][\w]*)\s*:/gm,r=i.exec(e);for(;r;)t.push(r[1]),r=i.exec(e);return t}function I(e,t,i,r){let n=0,s=0,a=!1;for(let o=t;o<e.length;o++){let t=e[o],u=e[o+1];if(a){"\n"===t&&(a=!1);continue}if(s>0){"/"===t&&"*"===u?(s++,o++):"*"===t&&"/"===u&&(s--,o++);continue}if("/"===t&&"/"===u){a=!0,o++;continue}if("/"===t&&"*"===u){s=1,o++;continue}if(t===i&&n++,t===r&&0==--n)return o}return -1}function R(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function N(e,t,i){let r=RegExp(`\\bfn\\s+${j(t)}\\s*\\(`,"g").exec(e);if(!r)throw Error(`ShaderPlugin varyings require WGSL ${i} entry point "${t}"`);let n=e.indexOf("(",r.index),s=V(e,n,"(",")"),a=e.indexOf("{",s),o=V(e,a,"{","}");if(s<0||a<0||o<0)throw Error(`Unable to parse WGSL ${i} entry point "${t}"`);return{openParenthesis:n,closeParenthesis:s,openBrace:a,closeBrace:o,parameters:e.slice(n+1,s)}}function k(e,t){let i=F(e,t);if(!i)throw Error(`Unable to find WGSL stage I/O struct "${t}"`);return i}function F(e,t){let i=RegExp(`\\bstruct\\s+${j(t)}\\s*\\{`,"g").exec(e);if(!i)return null;let r=e.indexOf("{",i.index),n=V(e,r,"{","}");return n<0?null:{openBrace:r,closeBrace:n,body:e.slice(r+1,n)}}function U(e,t,i){let r=t;if("/"===e[r]&&"/"===e[r+1]){let t=e.indexOf("\n",r+2);return t<0||t>i?i:t+1}if("/"===e[r]&&"*"===e[r+1]){let t=1;for(r+=2;r<i&&t>0;)"/"===e[r]&&"*"===e[r+1]?(t++,r+=2):"*"===e[r]&&"/"===e[r+1]?(t--,r+=2):r++}return r}function D(e){let t=[],i=/@location\s*\(\s*(\d+)\s*\)/g,r=i.exec(e);for(;r;)t.push(Number(r[1])),r=i.exec(e);return t}function z(e){let t=[],i=/(?:^|,)\s*(?:@[A-Za-z_][\w]*(?:\([^)]*\))?\s*)*([A-Za-z_][\w]*)\s*:/gm,r=i.exec(e);for(;r;)t.push(r[1]),r=i.exec(e);return t}function V(e,t,i,r){let n=0,s=0,a=!1;for(let o=t;o<e.length;o++){let t=e[o],u=e[o+1];if(a){"\n"===t&&(a=!1);continue}if(s>0){"/"===t&&"*"===u?(s++,o++):"*"===t&&"/"===u&&(s--,o++);continue}if("/"===t&&"/"===u){a=!0,o++;continue}if("/"===t&&"*"===u){s=1,o++;continue}if(t===i&&n++,t===r&&0==--n)return o}return -1}function j(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}let G=`

${s.O_}
`,W=`\
precision highp float;
`;function q(e,t){let{source:i,stage:n,language:a="glsl",modules:f,defines:g={},hookFunctions:m=[],inject:_={},pluginInjections:b={},pluginVertexInputs:y={},pluginVaryings:v={},prologue:w=!0,log:E}=t;(0,p.v)("string"==typeof i,"shader source must be a string");let x="glsl"===a?({name:function(e,t="unnamed"){let i=/#define[^\S\r\n]*SHADER_NAME[^\S\r\n]*([A-Za-z0-9_-]+)\s*/.exec(e);return i?i[1]:t}(i,void 0),language:"glsl",version:function(e){let t=100,i=e.match(/[^\s]+/g);if(i&&i.length>=2&&"#version"===i[0]){let e=parseInt(i[1],10);Number.isFinite(e)&&(t=e)}if(100!==t&&300!==t)throw Error(`Invalid GLSL version ${t}`);return t}(i)}).version:-1,S=e.shaderLanguageVersion,A=100===x?"#version 100":"#version 300 es",L=i.split("\n").slice(1).join("\n"),B={};f.forEach(e=>{Object.assign(B,e.defines)}),Object.assign(B,g);let T="";switch(a){case"wgsl":break;case"glsl":T=w?`\
${A}
...
`:`${A}
`}let P=d(m),O={},C={},I={};for(let e in Y(b,O,C,I),_){let t="string"==typeof _[e]?{injection:_[e],order:0}:_[e],i=/^(v|f)s:(#)?([\w-]+)$/.exec(e);if(i){let r=i[2],n=i[3];r?"decl"===n?C[e]=[t]:I[e]=[t]:O[e]=[t]}else I[e]=[t]}if("vertex"===n){let e=function(e,t){let i=[];for(let[r,n]of Object.entries(t))(function(e,t){let i=R(t);if(RegExp(`\\b(?:in|attribute)\\s+(?:(?:lowp|mediump|highp)\\s+)?[A-Za-z_][A-Za-z0-9_]*\\s+${i}\\s*(?:\\[|;)`).test(e))throw Error(`ShaderPlugin vertex input "${t}" conflicts with an existing GLSL input`)})(e,r),i.push(`in ${$(n)} ${r};`);return i.join("\n")}(L,y);e&&(C["vs:#decl"]=C["vs:#decl"]||[],C["vs:#decl"].push({injection:e,order:Number.MIN_SAFE_INTEGER}))}let N=function(e,t,i){let r=[],n=[];for(let[o,u]of Object.entries(i)){var s=e,a=o;if(RegExp(`\\b(?:flat\\s+|smooth\\s+)?(?:in|out|varying)\\s+(?:(?:lowp|mediump|highp)\\s+)?[A-Za-z_][A-Za-z0-9_]*\\s+${j(a)}\\s*(?:\\[|;)`).test(s))throw Error(`ShaderPlugin varying "${a}" conflicts with existing GLSL stage I/O`);let i="flat"===u.interpolation?"flat ":"",l="vertex"===t?"out":"in";r.push(`${i}${l} ${$(u.type)} ${o};`),"vertex"===t&&n.push(`${o} = ${function(e){let{primitiveType:t,components:i}=M.Co.getAttributeShaderTypeInfo(e),r="u32"===t?"0u":"i32"===t?"0":"0.0";return 1===i?r:`${$(e)}(${r})`}(u.type)};`)}return{declarations:r.join("\n"),initialization:n.join("\n")}}(L,n,v);if(N.declarations){let e="vertex"===n?"vs:#decl":"fs:#decl";C[e]=C[e]||[],C[e].push({injection:N.declarations,order:Number.MIN_SAFE_INTEGER})}for(let e of(N.initialization&&(I["vs:#main-start"]=I["vs:#main-start"]||[],I["vs:#main-start"].push({injection:N.initialization,order:Number.MIN_SAFE_INTEGER})),f)){E&&(0,r.ZG)(e,L,E),T+=X(e,n,E);let t=e.instance?.normalizedInjections[n]||{};for(let e in t){let i=/^(v|f)s:#([\w-]+)$/.exec(e);if(i){let r="decl"===i[2]?C:I;r[e]=r[e]||[],r[e].push(t[e])}else O[e]=O[e]||[],O[e].push(t[e])}}return T+="// ----- MAIN SHADER SOURCE -------------------------",T+=G,T=(0,s.bv)(T,n,C)+c(P[n],O)+L,T=(0,s.bv)(T,n,I),"glsl"===a&&x!==S&&(T=function(e,t){if(300!==Number(e.match(/^#version[ \t]+(\d+)/m)?.[1]||100))throw Error("luma.gl v9 only supports GLSL 3.00 shader sources");switch(t){case"vertex":return l(e,o);case"fragment":return l(e,u);default:throw Error(t)}}(T,n)),"glsl"===a&&(0,h.N1)(T,n,E),T.trim()}function H(e){return function(t){let i={};for(let r of e){let e=r.getUniforms?.(t,i);Object.assign(i,e)}return i}}function Y(e,t,i,r){for(let n in e){let s=/^(v|f)s:(#)?([\w-]+)$/.exec(n);if(s){let a=s[2],o=s[3],u=a?"decl"===o?i:r:t;u[n]=u[n]||[],u[n].push(...e[n])}else r[n]=r[n]||[],r[n].push(...e[n])}}function X(e,t,i){let r;switch(t){case"vertex":r=e.vs||"";break;case"fragment":r=e.fs||"";break;case"wgsl":r=e.source||"";break;default:(0,p.v)(!1)}if(!e.name)throw Error("Shader module must have a name");(0,h.mY)(e,t,{log:i});let n=e.name.toUpperCase().replace(/[^0-9a-z]/gi,"_"),s=`\
// ----- MODULE ${e.name} ---------------

`;return"wgsl"!==t&&(s+=`#define MODULE_${n}
`),s+=`${r}
`}function Z(e,t,i){if(0===e&&t>=100)throw Error(`Application binding "${i}" in group 0 uses reserved binding ${t}. Application-owned explicit group-0 bindings must stay below 100.`)}function K(e,t,i,r){if(0===t&&i<100)throw Error(`Module "${e}" binding "${r}" in group 0 uses reserved application binding ${i}. Module-owned explicit group-0 bindings must be 100 or higher.`)}function Q(e,t,i,r){let n=e.get(t)||new Set;if(n.has(i))throw Error(`Duplicate WGSL binding assignment for ${r}: group ${t}, binding ${i}.`);n.add(i),e.set(t,n)}function J(e,t,i){return`${e}:${t}:${i}`}class ee{static defaultShaderAssemblers={};_hookFunctions=[];_defaultModules=[];static getDefaultShaderAssembler(e){return((0,p.v)("glsl"===e||"wgsl"===e),"wgsl"===e)?(ee.defaultShaderAssemblers.wgsl=ee.defaultShaderAssemblers.wgsl||new ei,ee.defaultShaderAssemblers.wgsl):(ee.defaultShaderAssemblers.glsl=ee.defaultShaderAssemblers.glsl||new et,ee.defaultShaderAssemblers.glsl)}addDefaultModule(e){this._defaultModules.find(t=>t.name===("string"==typeof e?e:e.name))||this._defaultModules.push(e)}removeDefaultModule(e){let t="string"==typeof e?e:e.name;this._defaultModules=this._defaultModules.filter(e=>e.name!==t)}addShaderHook(e,t){t&&(e=Object.assign(t,{hook:e})),this._hookFunctions.push(e)}_getModuleList(e=[]){let t=Array(this._defaultModules.length+e.length),i={},n=0;for(let e=0,r=this._defaultModules.length;e<r;++e){let r=this._defaultModules[e],s=r.name;t[n++]=r,i[s]=!0}for(let r=0,s=e.length;r<s;++r){let s=e[r],a=s.name;i[a]||(t[n++]=s,i[a]=!0)}return t.length=n,(0,r.$g)(t),t}}class et extends ee{shaderLanguage="glsl";assembleGLSLShaderPair(e){let t=this._getModuleList(e.modules),i=this._hookFunctions;return{...function(e){let{vs:t,fs:i}=e,r=(0,n.$Q)(e.modules||[]);return{vs:q(e.platformInfo,{...e,source:t,stage:"vertex",modules:r}),fs:q(e.platformInfo,{...e,source:i,stage:"fragment",modules:r}),getUniforms:H(r)}}({...e,vs:e.vs,fs:e.fs,modules:t,hookFunctions:i}),modules:t}}}class ei extends ee{shaderLanguage="wgsl";_wgslBindingRegistry=new Map;assembleWGSLShader(e){let t=this._getModuleList(e.modules),i=this._hookFunctions,a=ei.getShaderPreprocessorDefines(e,t),o="wgsl"===e.platformInfo.shaderLanguage&&e.source?P(e.source,{defines:a}):e.source,{source:u,getUniforms:l,bindingAssignments:f}=function(e){let t=(0,n.$Q)(e.modules||[]),{source:i,bindingAssignments:a}=function(e,t){var i,n,a,o,u,l,f,h,m,_,b;let y,{source:v,stage:w,modules:E,defines:x={},hookFunctions:S=[],inject:A={},pluginInjections:L={},pluginVertexInputs:B={},pluginVaryings:T={},vertexEntryPoint:$="vertexMain",fragmentEntryPoint:W="fragmentMain",log:q}=t;(0,p.v)("string"==typeof v,"shader source must be a string");let H=function(e,t,i){let r=Object.entries(i);if(0===r.length)return{source:e,declarations:"",initialization:""};let n=function(e,t){let i=RegExp(`\\bfn\\s+${R(t)}\\s*\\(`,"g").exec(e);if(!i)throw Error(`ShaderPlugin vertex inputs require WGSL vertex entry point "${t}"`);let r=e.indexOf("(",i.index),n=I(e,r,"(",")");if(n<0)throw Error(`Unable to parse WGSL vertex entry point "${t}" parameters`);return{openParenthesis:r,closeParenthesis:n}}(e,t),s=e.slice(n.openParenthesis+1,n.closeParenthesis),a=function(e,t){let i=O(t),r=new Set(C(t));for(let n of function(e){let t=[],i=/:\s*([A-Za-z_][\w]*)\b/g,r=i.exec(e);for(;r;)t.push(r[1]),r=i.exec(e);return t}(t)){let t=function(e,t){let i=RegExp(`\\bstruct\\s+${R(t)}\\s*\\{`,"g").exec(e);if(!i)return null;let r=e.indexOf("{",i.index),n=I(e,r,"{","}");return n<0?null:e.slice(r+1,n)}(e,n);if(null!==t)for(let e of(i.push(...O(t)),C(t)))r.add(e)}return{locations:i,names:r}}(e,s),o=new Set(a.locations),u=[],l=[],f=[];for(let[t,i]of r){if(a.names.has(t)||function(e,t){let i=R(t),r=RegExp(`\\b(?:var(?:<[^>]+>)?|let|const)\\s+${i}\\b`,"g"),n=r.exec(e);for(;n;){if(0===function(e,t){let i=0,r=0,n=!1;for(let s=0;s<t;s++){let t=e[s],a=e[s+1];if(n){"\n"===t&&(n=!1);continue}if(r>0){"/"===t&&"*"===a?(r++,s++):"*"===t&&"/"===a&&(r--,s++);continue}"/"===t&&"/"===a?(n=!0,s++):"/"===t&&"*"===a?(r=1,s++):"{"===t?i++:"}"===t&&i--}return i}(e,n.index))return!0;n=r.exec(e)}return!1}(e,t))throw Error(`ShaderPlugin vertex input "${t}" conflicts with an existing WGSL shader input or variable`);let r=function(e){let t=0;for(;e.has(t);)t++;return t}(o);o.add(r);let n=`_luma_${t}`;u.push(`@location(${r}) ${n}: ${i}`),l.push(`var<private> ${t}: ${i};`),f.push(`${t} = ${n};`)}let h=s.trim()?",\n  ":"\n  ",c=s.trim()?"":"\n",d=`${s}${h}${u.join(",\n  ")}${c}`;return{source:e.slice(0,n.openParenthesis+1)+d+e.slice(n.closeParenthesis),declarations:l.join("\n"),initialization:f.join("\n")}}(P(v,{defines:x}),$,B),ee=function(e,t,i,r){let n=Object.entries(r);if(0===n.length)return{source:e,declarations:"",vertexInitialization:"",fragmentInitialization:""};let s=e,a=N(s,t,"vertex"),o=function(e,t){let i=e.slice(t.closeParenthesis+1,t.openBrace),r=/->\s*([A-Za-z_][\w]*)\s*$/.exec(i.trim());if(!r||null===F(e,r[1]))throw Error("ShaderPlugin varyings require the WGSL vertex entry point to return a named struct");return r[1]}(s,a),u=N(s,i,"fragment"),l=function(e,t){let i=[];for(let r of function(e){let t=[],i=0,r=0,n=0;for(let s=0;s<e.length;s++){let a=e[s];"("===a&&r++,")"===a&&r--,"<"===a&&n++,">"===a&&n--,","===a&&0===r&&0===n&&(t.push(e.slice(i,s)),i=s+1)}return t.push(e.slice(i)),t}(t.parameters)){let t=/(?:@[A-Za-z_][\w]*(?:\([^)]*\))?\s*)*([A-Za-z_][\w]*)\s*:\s*([A-Za-z_][\w]*)\s*$/.exec(r.trim());t&&F(e,t[2])&&i.push({name:t[1],type:t[2]})}if(1!==i.length)throw Error(`ShaderPlugin varyings require exactly one named WGSL fragment input struct; found ${i.length}`);return i[0]}(s,u),f=k(s,o),h=k(s,l.type),c=new Set([...z(a.parameters),...z(f.body),...z(u.parameters),...z(h.body)]),d=new Set([...D(f.body),...D(h.body)]),p=[],g=[],m=[],_=[];for(let[e,t]of n){if(c.has(e)||function(e,t){let i=RegExp(`\\b(?:var(?:<[^>]+>)?|let|const)\\s+${j(t)}\\b`,"g"),r=i.exec(e);for(;r;){if(0===function(e,t){let i=0;for(let r=0;r<t;r++){let n=U(e,r,t);if(n!==r){r=n-1;continue}"{"===e[r]&&i++,"}"===e[r]&&i--}return i}(e,r.index))return!0;r=i.exec(e)}return!1}(s,e))throw Error(`ShaderPlugin varying "${e}" conflicts with existing WGSL stage I/O or a module variable`);let i=function(e){let t=0;for(;e.has(t);)t++;return t}(d);d.add(i);let r="flat"===t.interpolation?" @interpolate(flat)":"";p.push(`  @location(${i})${r} ${e}: ${t.type},`),g.push(`var<private> ${e}: ${t.type};`),m.push(`${e} = ${function(e){let{primitiveType:t,components:i}=M.Co.getAttributeShaderTypeInfo(e),r=`${t}(0)`;return 1===i?r:`${e}(${r})`}(t.type)};`),_.push(`${e} = ${l.name}.${e};`)}for(let e of(function(e,t,i,r){let n=RegExp(`\\b${j(t)}\\s*\\(`,"g"),s=n.exec(e);for(;s;){if(s.index<i||s.index>r)throw Error(`ShaderPlugin varying output struct "${t}" is constructed outside the selected vertex entry point`);s=n.exec(e)}}(s,o,a.openBrace,a.closeBrace),a=N(s=function(e,t,i,r){let n=RegExp(`\\b${j(t)}\\s*\\(`,"g"),s=[],a=n.exec(e);for(;a;){if(a.index>i.openBrace&&a.index<i.closeBrace){let r=e.indexOf("(",a.index),n=V(e,r,"(",")");if(n<0||n>i.closeBrace)throw Error(`Unable to parse WGSL output constructor "${t}"`);s.push({openParenthesis:r,closeParenthesis:n})}a=n.exec(e)}for(let t of s.sort((e,t)=>t.closeParenthesis-e.closeParenthesis)){let i=e.slice(t.openParenthesis+1,t.closeParenthesis).trim()?", ":"";e=e.slice(0,t.closeParenthesis)+i+r.join(", ")+e.slice(t.closeParenthesis)}return e}(s,o,a,n.map(([e])=>e)),t,"vertex"),s=function(e,t,i){let r=function(e,t,i){let r=[],n=t;for(;n<i;)if(n=U(e,n,i),"return"!==e.slice(n,n+6)||/[A-Za-z0-9_]/.test(e[n+6]||""))n++;else{let t=n+6,s=function(e,t,i){let r=0,n=0;for(let s=t;s<i;s++){let t=U(e,s,i);if(t!==s){s=t-1;continue}let a=e[s];if("("===a&&r++,")"===a&&r--,"["===a&&n++,"]"===a&&n--,";"===a&&0===r&&0===n)return s}return -1}(e,t,i);if(s<0)throw Error("Unable to parse WGSL return statement in selected vertex entry point");r.push({start:n,expressionStart:t,semicolon:s}),n=s+1}return r}(e,t.openBrace+1,t.closeBrace);for(let t=r.length-1;t>=0;t--){let n=r[t],s=e.slice(n.expressionStart,n.semicolon).trim();if(!s)throw Error("ShaderPlugin varying vertex entry point cannot use an empty return");let a=`_luma_vertexOutput${t}`,o=i.map(e=>`${a}.${e} = ${e};`).join("\n"),u=`{
var ${a} = ${s};
${o}
return ${a};
}`;e=e.slice(0,n.start)+u+e.slice(n.semicolon+1)}return e}(s,a,n.map(([e])=>e)),(o===l.type?[o]:[o,l.type]).map(e=>k(s,e).closeBrace).sort((e,t)=>t-e)))s=s.slice(0,e)+`${p.join("\n")}
`+s.slice(e);if(u=N(s,i,"fragment"),!RegExp(`\\b${j(l.name)}\\s*:`).test(u.parameters))throw Error(`Unable to preserve WGSL fragment input "${l.name}"`);return{source:s,declarations:g.join("\n"),vertexInitialization:m.join("\n"),fragmentInitialization:_.join("\n")}}(H.source,$,W,T),et=ee.source,ei="",er=d(S),en={},es={},ea={};for(let e in Y(L,en,es,ea),A){let t="string"==typeof A[e]?{injection:A[e],order:0}:A[e],i=/^(v|f)s:(#)?([\w-]+)$/.exec(e);if(i){let r=i[2],n=i[3];r?"decl"===n?es[e]=[t]:ea[e]=[t]:en[e]=[t]}else ea[e]=[t]}i=H.declarations,n=H.initialization,a=es,o=ea,i&&(a["vs:#decl"]=a["vs:#decl"]||[],a["vs:#decl"].push({injection:i,order:Number.MIN_SAFE_INTEGER})),n&&(o["vs:#main-start"]=o["vs:#main-start"]||[],o["vs:#main-start"].push({injection:n,order:Number.MIN_SAFE_INTEGER})),u=ee,l=es,f=ea,u.declarations&&(l["vs:#decl"]=l["vs:#decl"]||[],l["vs:#decl"].push({injection:u.declarations,order:Number.MIN_SAFE_INTEGER})),u.vertexInitialization&&(f["vs:#main-start"]=f["vs:#main-start"]||[],f["vs:#main-start"].push({injection:u.vertexInitialization,order:Number.MIN_SAFE_INTEGER})),u.fragmentInitialization&&(f["fs:#main-start"]=f["fs:#main-start"]||[],f["fs:#main-start"].push({injection:u.fragmentInitialization,order:Number.MIN_SAFE_INTEGER}));let eo=function(e){let t=(0,g.M8)(e,g.z9),i=new Map;for(let e of t){if("auto"===e.bindingToken)continue;let t=Number(e.bindingToken),r=Number(e.groupToken);Z(r,t,e.name),Q(i,r,t,`application binding "${e.name}"`)}let r={sawSupportedBindingDeclaration:t.length>0},n=(0,g.u5)(e,g.z9,e=>(function(e,t,i){let{match:r,bindingToken:n,groupToken:s,name:a}=e,o=Number(s);if("auto"===n){let e=function(e,t){let i=t.get(e)||new Set,r=0;for(;i.has(r);)r++;return r}(o,t);return Z(o,e,a),Q(t,o,e,`application binding "${a}"`),r.replace(/@binding\(\s*auto\s*\)/,`@binding(${e})`)}return i.sawSupportedBindingDeclaration=!0,r})(e,i,r));if((0,g.CH)(e)&&!r.sawSupportedBindingDeclaration)throw Error('Unsupported @binding(auto) declaration form in application WGSL. Use adjacent "@group(N)" and "@binding(auto)" decorators followed by a bindable "var" declaration.');return{source:n}}(et),eu=function(e){let t=new Map;for(let i of(0,g.M8)(e,g.q2)){let e=Number(i.bindingToken),r=Number(i.groupToken);Z(r,e,i.name),Q(t,r,e,`application binding "${i.name}"`)}return t}(eo.source),el=function(e,t,i,r){let n=new Map;if(!t)return n;for(let s of e)for(let e of function(e,t){let i=[],r=P(e.source||"",{defines:t});for(let e of(0,g.M8)(r,g.eB))i.push({name:e.name,group:Number(e.groupToken)});return i}(s,r)){let r=J(e.group,s.name,e.name),a=t.get(r);if(void 0!==a){let t=n.get(e.group)||new Map,s=t.get(a);if(s&&s!==r)throw Error(`Duplicate WGSL binding reservation for modules "${s}" and "${r}": group ${e.group}, binding ${a}.`);Q(i,e.group,a,`registered module binding "${r}"`),t.set(a,r),n.set(e.group,t)}}return n}(E,t._bindingRegistry,eu,x),ef=[];for(let e of E){q&&(0,r.ZG)(e,et,q);let i=function(e,t,i){let r=[],n={sawSupportedBindingDeclaration:(0,g.M8)(e,g.eB).length>0,nextHintedBindingLocation:"number"==typeof t.firstBindingSlot?t.firstBindingSlot:null},s=(0,g.u5)(e,g.eB,e=>(function(e,t){let{module:i,context:r,bindingAssignments:n,relocationState:s}=t,{match:a,bindingToken:o,groupToken:u,name:l}=e,f=Number(u);if("auto"===o){let e=J(f,i.name,l),t=r.bindingRegistry?.get(e),o=void 0!==t?t:function(e,t,i,r,n){let s=t.get(e)||new Set,a=new Set,o=`${e}:`,u=`${o}${i}:`;for(let[e,t]of n||[])e.startsWith(u)&&a.add(t);let l=r??(0===e?100:s.size>0?Math.max(...s)+1:0);for(;s.has(l)||a.has(l);)l++;for(let[e,t]of n||[])t===l&&e.startsWith(o)&&n?.delete(e);return l}(f,r.usedBindingsByGroup,i.name,s.nextHintedBindingLocation??void 0,r.bindingRegistry);return(K(i.name,f,o,l),void 0!==t&&function(e,t,i,r){let n=e.get(t);if(!n)return!1;let s=n.get(i);if(!s)return!1;if(s!==r)throw Error(`Registered module binding "${r}" collided with "${s}": group ${t}, binding ${i}.`);return!0}(r.reservedBindingKeysByGroup,f,o,e))?n.push({moduleName:i.name,name:l,group:f,location:o}):(Q(r.usedBindingsByGroup,f,o,`module "${i.name}" binding "${l}"`),r.bindingRegistry?.set(e,o),n.push({moduleName:i.name,name:l,group:f,location:o}),null!==s.nextHintedBindingLocation&&void 0===t&&(s.nextHintedBindingLocation=o+1)),a.replace(/@binding\(\s*auto\s*\)/,`@binding(${o})`)}let h=Number(o);return K(i.name,f,h,l),Q(r.usedBindingsByGroup,f,h,`module "${i.name}" binding "${l}"`),n.push({moduleName:i.name,name:l,group:f,location:h}),a})(e,{module:t,context:i,bindingAssignments:r,relocationState:n}));if((0,g.CH)(e)&&!n.sawSupportedBindingDeclaration)throw Error(`Unsupported @binding(auto) declaration form in module "${t.name}". Use adjacent "@group(N)" and "@binding(auto)" decorators followed by a bindable "var" declaration.`);return{source:s,bindingAssignments:r}}(P(X(e,"wgsl",q),{defines:x}),e,{usedBindingsByGroup:eu,bindingRegistry:t._bindingRegistry,reservedBindingKeysByGroup:el});ef.push(...i.bindingAssignments),ei+=i.source;let n=(h=e,{...h.instance?.normalizedInjections.vertex||{},...h.instance?.normalizedInjections.fragment||{}});for(let e in n){let t=/^(v|f)s:#([\w-]+)$/.exec(e);if(t){let i="decl"===t[2]?es:ea;i[e]=i[e]||[],i[e].push(n[e])}else en[e]=en[e]||[],en[e].push(n[e])}}return ei+=G,ei=(0,s.bv)(ei,w,(y=[...(m=es)["vs:#decl"]||[],...m["fs:#decl"]||[]]).length?{"vs:#decl":y}:{},!1,"wgsl",{vertex:$,fragment:W})+(_=er,b=en,c(_.vertex,b,"wgsl")+c(_.fragment,b,"wgsl"))+function(e){if(0===e.length)return"";let t="// ----- MODULE WGSL BINDING ASSIGNMENTS ---------------\n";for(let i of e)t+=`// ${i.moduleName}.${i.name} -> @group(${i.group}) @binding(${i.location})
`;return t+"\n"}(ef)+eo.source,function(e){var t,i;let r,n=(0,g.lh)(e,g.eB);if(!n)return;let s=function(e,t){let i,r,n=/^\/\/ ----- MODULE ([^\n]+) ---------------$/gm;for(r=n.exec(e);r&&r.index<=t;)i=r[1],r=n.exec(e);return i}(e,n.index);if(s)throw Error(`Unresolved @binding(auto) for module "${s}" binding "${n.name}" remained in assembled WGSL source.`);if(t=e,i=n.index,!((r=t.indexOf(G))>=0)||i>r)throw Error(`Unresolved @binding(auto) for application binding "${n.name}" remained in assembled WGSL source.`);throw Error(`Unresolved @binding(auto) remained in assembled WGSL source near "${n.match.replace(/\s+/g," ").trim()}".`)}(ei=(0,s.bv)(ei,w,ea,!1,"wgsl",{vertex:$,fragment:W})),{source:ei,bindingAssignments:ef}}(e.platformInfo,{...e,source:e.source,stage:"vertex",modules:t});return{source:i,getUniforms:H(t),bindingAssignments:a,bindingTable:_(i,a),shaderLayout:(0,v.A)(i,{vertexEntryPoint:e.vertexEntryPoint,scanVertexAttributes:e.scanVertexAttributes})}}({...e,source:o,defines:a,_bindingRegistry:this._wgslBindingRegistry,modules:t,hookFunctions:i}),h="wgsl"===e.platformInfo.shaderLanguage?P(u,{defines:a}):u;return{source:h,getUniforms:l,modules:t,bindingAssignments:f,bindingTable:_(h,f),shaderLayout:(0,v.A)(h,{vertexEntryPoint:e.vertexEntryPoint,scanVertexAttributes:e.scanVertexAttributes})}}static getShaderPreprocessorDefines(e,t){return{...ei.getPlatformPreprocessorDefines(e.platformInfo),...t.reduce((e,t)=>(Object.assign(e,t.defines),e),{}),...e.defines}}static getPlatformPreprocessorDefines(e){let t=e.limits||{};return{LUMA_SUPPORTS_VERTEX_STORAGE_BUFFERS:"webgpu"===e.type&&(t.maxStorageBuffersInVertexStage||0)>0,LUMA_FP32_TAN_PRECISION_WORKAROUND:"webgpu"===e.type&&"nvidia"!==e.gpu.toLowerCase()&&"amd"!==e.gpu.toLowerCase(),LUMA_FP64_INTEGER_ARITHMETIC:"webgpu"===e.type&&"apple"===e.gpu.toLowerCase()}}}},31770(e,t,i){i.d(t,{O_:()=>o,bv:()=>l,Uu:()=>u});let r={vertex:`\
...
`,getUniforms:function(e={},t){let i={},n=(0,r.eS)(e.useByteColors,!0);return void 0===e.highlightedObjectColor||(null===e.highlightedObjectColor?i.isHighlightActive=!1:(i.isHighlightActive=!0,i.highlightedObjectColor=e.highlightedObjectColor.slice(0,3))),e.highlightColor&&(i.highlightColor=(0,r.jI)(e.highlightColor,n)),void 0!==e.isActive&&(i.isActive=!!e.isActive,i.isAttribute=!!e.isAttribute),void 0!==e.useByteColors&&(i.useByteColors=!!e.useByteColors),i}}},22270(e,t,i){i.d(t,{i:()=>r});let r={name:"fp32",source:`\
