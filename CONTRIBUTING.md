...
- The best PR description is a short set of **bulletpoints written by a human**. See the [PR description guidelines](https://github.com/visgl/deck.gl/tree/master/dev-docs/pr-description-guidelines.md). Maintainers may ask for a rewrite or close a PR whose description does not follow them.
