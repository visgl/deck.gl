...
export default class PathMarkerLayer extends CompositeLayer {
  ...
  updateState({props, oldProps, changeFlags}) {
    if (changeFlags.dataChanged) {
      const {data, getPath, getDirection, getDirectionColor, getMarkerPercentages} = this.props;
      this.state.markers = createPathMarkers({
        data, getPath, getDirection, getColor: getDirectionColor, getMarkerPercentages
      });
